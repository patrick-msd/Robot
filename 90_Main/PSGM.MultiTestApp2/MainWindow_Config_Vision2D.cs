...
namespace PSGM.MultiTestApp1
{
    ...
    {
        public static DbMachine_Device Vision2D_001()
        {
            Debug.Write("Create Device -\"Vision 2d Right\" ...");
            ...
            SVSVistek_Camera_Config cameraConfig = new SVSVistek_Camera_Config()
            {
                ...
                AnalogControl = new AnalogControl()
                {
                    ...
                    GainAutoMin = 0.000d,
                    GainAutoMax = 36.000d,
                    BalanceWhiteRatioRed = 1.32813d,
                    BalanceWhiteRatioGreen = 1.000d,
                    BalanceWhiteRatioBlue = 1.87891d,
        ...
        public static DbMachine_Device Vision2D_002()
        {
            Debug.Write("Create Device -\"Vision 2d Right\" ...");
