...
// Informations
// https://stackoverflow.com/questions/1873339/c-cli-casting-from-unmanaged-enum-to-managed-enum
...
//public:
	...
	public enum class RobotControl {
		CONTROL_INIT_CONFIG,
	...
	public enum class MonitoringSpeed {
		SPEED_NORMAL_MODE,
		SPEED_REDUCED_MODE
	};

	// 
	typedef MonitoringSpeed SpeedMode;

	// robot system enumerated value
	public enum class RobotSystem {
		ROBOT_SYSTEM_REAL,
	...
	public enum class RobotSpace {
		ROBOT_SPACE_JOINT,
		ROBOT_SPACE_TASK
	};

	// 
	public enum class JogAxis {
		JOG_AXIS_JOINT_1 = 0,
		JOG_AXIS_JOINT_2,
		JOG_AXIS_JOINT_3,
		JOG_AXIS_JOINT_4,
	...
	public enum class MoveReference {
	...
	//
	public enum class SingularityAvoidance {
	...
	public enum class ManageAccessControl {
	...
	public enum class MonitoringAccessControl {
	...
	public enum class SplineVelocityOption {
	...
	//
	public enum class SubProgram {
		SUB_PROGRAM_DELETE = 0,
		SUB_PROGRAM_SAVE
	};

	// gpio index enumerated value
	public enum class GpioCtrlboxDigitalIndex {
	...
	//
	public enum class GpioCtrlboxAnalogIndex {
		GPIO_CTRLBOX_ANALOG_INDEX_1 = 0,
		GPIO_CTRLBOX_ANALOG_INDEX_2
	};

	//
	public enum class GpioToolDigitalIndex {
	...
	public enum class DrlProgramState {
	...
	public enum class ProgramStopCause {
	...
	//
	public enum class PopupResponse {
		POPUP_RESPONSE_STOP,
		POPUP_RESPONSE_RESUME
	};

	// 
	public enum class RobotAxis {
		ROBOT_AXIS_1 = 0,
		ROBOT_AXIS_2,
		ROBOT_AXIS_3,
		ROBOT_AXIS_4,
	...
	public enum class LogGroupSysemfmk {
	...
	public enum class LogGroupMotionlib {
		RC_ERROR_NO_ERROR = 0,
	...
	public enum class LogGroupInverter {
		/* Inverter Fault Code */
	...
	public enum class LogGroupSafetyControler {
