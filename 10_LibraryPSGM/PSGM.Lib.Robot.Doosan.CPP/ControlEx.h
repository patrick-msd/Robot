...
namespace PSGMRobotDoosanControl
{
	...
	public delegate void ManagedTOnTpInitializingCompletedCB();
	public delegate void ManagedTOnMasteringNeedCB();
	public delegate void ManagedTOnDisconnectedCB();
	...
	public:
		...
		RobotPose GetDesiredPosx([Optional] Nullable<CoordinateSystem> eCoodType);

		//double GetOverrideSpeed();
		float GetWorkpieceWeight();
		bool ResetWorkpieceWeight();
		bool TpPopupResponse(PopupResponse eRes);
		bool TpGetUserInputResponse(String^ strUserInput);
