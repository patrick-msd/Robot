    ...
    public class SVSVistek_Api
    {
        ...
        internal static class NativeMethods
        {
			...
			*/
            ...
            SVSVistekApiReturn SVLibInit_64(byte* TLIPath = null,
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVLibInit_32(byte* TLIPath = null,
                                                 byte* genicamRootDir = null,
                                                 byte* genicamCacheDir = null,
                                                 byte* clProtocolDriverDir = null);
            internal static unsafe
            SVSVistekApiReturn SVLibInit(byte* TLIPath = null,
                                              byte* genicamRootDir = null,
                                              byte* genicamCacheDir = null,
                                              byte* clProtocolDriverDir = null)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVLibSystemGetInfo_64(uint uiIndex, ref _SV_TL_INFO pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLibSystemGetInfo", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVLibSystemGetInfo_32(uint uiIndex, ref _SV_TL_INFO pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVLibSystemGetInfo(uint uiIndex, ref _SV_TL_INFO pInfoOut)
            {
		 ...
		 */
            ...
            private static extern unsafe
            SVSVistekApiReturn SVLibSystemOpen_64(uint uiIndex, void* phSystemOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLibSystemOpen", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVLibSystemOpen_32(uint uiIndex, void* phSystemOut);
            internal static unsafe
            SVSVistekApiReturn SVLibSystemOpen(uint uiIndex, void* phSystemOut)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVSystemGetInfo_64(UInt32 index, void* pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVSystemGetInfo", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVSystemGetInfo_32(UInt32 index, void* pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVSystemGetInfo(UInt32 index, void* pInfoOut)
            {
		   ...
		   */
            ...
            private static extern unsafe
            SVSVistekApiReturn SVSystemUpdateInterfaceList_64(void* hSystem, bool* pbChanged, uint timeOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVSystemUpdateInterfaceList", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVSystemUpdateInterfaceList_32(void* hSystem, bool* pbChanged, uint timeOut);
            internal static unsafe
            SVSVistekApiReturn SVSystemUpdateInterfaceList(void* hSystem, bool* pbChanged, uint timeOut)
            {
		 ...
		 */
            ...
            private static extern unsafe
            SVSVistekApiReturn SVSystemGetNumInterfaces_64(void* hSystem, uint* piNumIfaces);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVSystemGetNumInterfaces", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVSystemGetNumInterfaces_32(void* hSystem, uint* piNumIfaces);
            internal static unsafe
            SVSVistekApiReturn SVSystemGetNumInterfaces(void* hSystem, uint* piNumIfaces)
            {
		 ...
		 */
            ...
            private static extern unsafe
            SVSVistekApiReturn SVSystemGetInterfaceId_64(void* hSystem, uint Index, sbyte* pInterfaceId, uint* pSize);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVSystemGetInterfaceId", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVSystemGetInterfaceId_32(void* hSystem, uint Index, sbyte* pInterfaceId, uint* pSize);
            internal static unsafe
            SVSVistekApiReturn SVSystemGetInterfaceId(void* hSystem, uint Index, sbyte* pInterfaceId, uint* pSize)
            {
		 ...
		 */
            ...
            private static extern unsafe
            SVSVistekApiReturn SVSystemInterfaceOpen_64(void* hSystem, byte* pInterfaceId, void* phInterfaceOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVSystemInterfaceOpen", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVSystemInterfaceOpen_32(void* hSystem, byte* pInterfaceId, void* phInterfaceOut);
            internal static unsafe
            SVSVistekApiReturn SVSystemInterfaceOpen(void* hSystem, byte* pInterfaceId, void* phInterfaceOut)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVSystemClose_64(void* hSystem);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVSystemClose", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVSystemClose_32(void* hSystem);
            internal static unsafe
            SVSVistekApiReturn SVSystemClose(void* hSystem)
            {
		 ...
		 */
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceGetInfo_64(void* hInterface, ref _SV_INTERFACE_INFO pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVInterfaceGetInfo", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceGetInfo_32(void* hInterface, ref _SV_INTERFACE_INFO pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceGetInfo(void* hInterface, ref _SV_INTERFACE_INFO pInfoOut)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceUpdateDeviceList_64(void* hInterface, bool* pbChanged, uint timeOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVInterfaceUpdateDeviceList", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceUpdateDeviceList_32(void* hInterface, bool* pbChanged, uint timeOut);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceUpdateDeviceList(void* hInterface, bool* pbChanged, uint timeOut)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceGetNumDevices_64(void* hInterface, uint* piDevices);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVInterfaceGetNumDevices", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceGetNumDevices_32(void* hInterface, uint* piDevices);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceGetNumDevices(void* hInterface, uint* piDevices)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceGetDeviceId_64(void* hInterface, uint Index, sbyte* pDeviceId, uint* pSize);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVInterfaceGetDeviceId", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceGetDeviceId_32(void* hInterface, uint Index, sbyte* pDeviceId, uint* pSize);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceGetDeviceId(void* hInterface, uint Index, sbyte* pDeviceId, uint* pSize)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceDeviceGetInfo_64(void* hInterface, byte* pDeviceId, ref _SV_DEVICE_INFO pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVInterfaceDeviceGetInfo", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceDeviceGetInfo_32(void* hInterface, byte* pDeviceId, ref _SV_DEVICE_INFO pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceDeviceGetInfo(void* hInterface, byte* pDeviceId, ref _SV_DEVICE_INFO pInfoOut)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceClose_64(void* hInterface);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVInterfaceClose", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceClose_32(void* hInterface);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceClose(void* hInterface)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceDeviceOpen_64(void* hInterface,
                                                    sbyte* pDeviceId,
            ...
            private static extern unsafe
            SVSVistekApiReturn SVInterfaceDeviceOpen_32(void* hInterface,
                                                    sbyte* pDeviceId,
                                                    SV_DEVICE_ACCESS_FLAGS_LIST accessFlags,
                                                    void* phDeviceOut,
                                                    void* phRemoteDeviceOut);
            internal static unsafe
            SVSVistekApiReturn SVInterfaceDeviceOpen(void* hInterface,
                                                    sbyte* pDeviceId,
                                                    SV_DEVICE_ACCESS_FLAGS_LIST accessFlags,
                                                    void* phDeviceOut,
                                                    void* phRemoteDeviceOut)
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVDeviceGetInfo_64(void* hDevice, ref _SV_DEVICE_INFO pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceGetInfo", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVDeviceGetInfo_32(void* hDevice, ref _SV_DEVICE_INFO pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVDeviceGetInfo(void* hDevice, ref _SV_DEVICE_INFO pInfoOut)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceGetNumStreams_64(void* hDevice, uint* piStreams);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceGetNumStreams", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceGetNumStreams_32(void* hDevice, uint* piStreams);
            internal static unsafe
            SVSVistekApiReturn SVDeviceGetNumStreams(void* hDevice, uint* piStreams)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceGetStreamId_64(void* hDevice, uint Index, sbyte* pStreamId, uint* pSize);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceGetStreamId", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceGetStreamId_32(void* hDevice, uint Index, sbyte* pStreamId, uint* pSize);
            internal static unsafe
            SVSVistekApiReturn SVDeviceGetStreamId(void* hDevice, uint Index, sbyte* pStreamId, uint* pSize)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceSaveSettings_64(void* hDevice, sbyte* fileName);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceSaveSettings", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceSaveSettings_32(void* hDevice, sbyte* fileName);
            internal static unsafe
            SVSVistekApiReturn SVDeviceSaveSettings(void* hDevice, sbyte* fileName)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceLoadSettings_64(void* hDevice, sbyte* fileName);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceLoadSettings", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceLoadSettings_32(void* hDevice, sbyte* fileName);
            internal static unsafe
            SVSVistekApiReturn SVDeviceLoadSettings(void* hDevice, sbyte* fileName)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceRead_64(void* hDevice, UInt64 nAddress, void* pData, uint* pSize);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceRead", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceRead_32(void* hDevice, UInt64 nAddress, void* pData, uint* pSize);
            internal static unsafe
            SVSVistekApiReturn SVDeviceRead(void* hDevice, UInt64 nAddress, void* pData, uint* pSize)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceWrite_64(void* hDevice, UInt64 nAddress, sbyte* pData, uint* pSize);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceWrite", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceWrite_32(void* hDevice, UInt64 nAddress, sbyte* pData, uint* pSize);
            internal static unsafe
            SVSVistekApiReturn SVDeviceWrite(void* hDevice, UInt64 nAddress, sbyte* pData, uint* pSize)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceStreamOpen_64(void* hDevice, sbyte* sDataStreamID, void* phStream);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceStreamOpen", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceStreamOpen_32(void* hDevice, sbyte* sDataStreamID, void* phStream);
            internal static unsafe
            SVSVistekApiReturn SVDeviceStreamOpen(void* hDevice, sbyte* sDataStreamID, void* phStream)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceClose_64(void* hDevice);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceClose", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceClose_32(void* hDevice);
            internal static unsafe
            SVSVistekApiReturn SVDeviceClose(void* hDevice)
            {
		  ...
		  */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAcquisitionStart_64(void* hStream, SV_ACQ_START_FLAGS_LIST flags, UInt64 iNumToAcquire);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamAcquisitionStart", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAcquisitionStart_32(void* hStream, SV_ACQ_START_FLAGS_LIST flags, UInt64 iNumToAcquire);
            internal static unsafe
            SVSVistekApiReturn SVStreamAcquisitionStart(void* hStream, SV_ACQ_START_FLAGS_LIST flags, UInt64 iNumToAcquire)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAcquisitionStop_64(void* hStream, SV_ACQ_STOP_FLAGS_LIST flags);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamAcquisitionStop", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAcquisitionStop_32(void* hStream, SV_ACQ_STOP_FLAGS_LIST flags);
            internal static unsafe
            SVSVistekApiReturn SVStreamAcquisitionStop(void* hStream, SV_ACQ_STOP_FLAGS_LIST flags)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAnnounceBuffer_64(void* hStream, sbyte* pBuffer, uint uiSize, void* pPrivate, void* phBuffer);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamAnnounceBuffer", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAnnounceBuffer_32(void* hStream, sbyte* pBuffer, uint uiSize, void* pPrivate, void* phBuffer);
            internal static unsafe
            SVSVistekApiReturn SVStreamAnnounceBuffer(void* hStream, sbyte* pBuffer, uint uiSize, void* pPrivate, void* phBuffer)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAllocAndAnnounceBuffer_64(void* hStream, uint uiSize, void* pPrivate, void* phBuffer);
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamAllocAndAnnounceBuffer_32(void* hStream, uint uiSize, void* pPrivate, void* phBuffer);
            internal static unsafe
            SVSVistekApiReturn SVStreamAllocAndAnnounceBuffer(void* hStream, uint uiSize, void* pPrivate, void* phBuffer)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamRevokeBuffer_64(void* hStream, void* hBuffer, void* pBuffer, void* pPrivate);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamRevokeBuffer", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamRevokeBuffer_32(void* hStream, void* hBuffer, void* pBuffer, void* pPrivate);
            internal static unsafe
            SVSVistekApiReturn SVStreamRevokeBuffer(void* hStream, void* hBuffer, void* pBuffer, void* pPrivate)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamQueueBuffer_64(void* hStream, void* hBuffer);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamQueueBuffer", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamQueueBuffer_32(void* hStream, void* hBuffer);
            internal static unsafe
            SVSVistekApiReturn SVStreamQueueBuffer(void* hStream, void* hBuffer)
            {
		  ...
		  */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamGetBufferId_64(void* hStream, uint iIndex, void* phBuffer);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamGetBufferId", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamGetBufferId_32(void* hStream, uint iIndex, void* phBuffer);
            internal static unsafe
            SVSVistekApiReturn SVStreamGetBufferId(void* hStream, uint iIndex, void* phBuffer)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamFlushQueue_64(void* hStream, SV_ACQ_QUEUE_TYPE_LIST iOperation);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamFlushQueue", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamFlushQueue_32(void* hStream, SV_ACQ_QUEUE_TYPE_LIST iOperation);
            internal static unsafe
            SVSVistekApiReturn SVStreamFlushQueue(void* hStream, SV_ACQ_QUEUE_TYPE_LIST iOperation)
            {
            ...
            private static extern unsafe
            SVSVistekApiReturn SVStreamWaitForNewBuffer_64(void* hStream, void* ppUserData, void* phBufferOut, uint timeOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamWaitForNewBuffer", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVStreamWaitForNewBuffer_32(void* hStream, void* ppUserData, void* phBufferOut, uint timeOut);
            internal static unsafe
            SVSVistekApiReturn SVStreamWaitForNewBuffer(void* hStream, void* ppUserData, void* phBufferOut, uint timeOut)
            {
			...
			*/
            ...
            private static extern unsafe
            SVSVistekApiReturn SVStreamBufferGetInfo_64(void* hStream, void* hBuffer, ref _SV_BUFFER_INFO pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamBufferGetInfo", CallingConvention = CallingConvention.Cdecl)]
            private static extern unsafe
            SVSVistekApiReturn SVStreamBufferGetInfo_32(void* hStream, void* hBuffer, ref _SV_BUFFER_INFO pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVStreamBufferGetInfo(void* hStream, void* hBuffer, ref _SV_BUFFER_INFO pInfoOut)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVStreamClose_64(void* hStream);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVStreamClose", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVStreamClose_32(void* hStream);
            internal static unsafe
            SVSVistekApiReturn SVStreamClose(void* hStream)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetByName_64(void* hModule, sbyte* featureName, void* phFeature);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetByName", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetByName_32(void* hModule, sbyte* featureName, void* phFeature);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetByName(void* hModule, sbyte* featureName, void* phFeature)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetByIndex_64(void* hModule, uint iIndex, void* phFeature);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetByIndex", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetByIndex_32(void* hModule, uint iIndex, void* phFeature);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetByIndex(void* hModule, uint iIndex, void* phFeature)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetInfo_64(void* hModule, void* hFeature, ref _SV_FEATURE_INFO pInfoOut);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetInfo", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetInfo_32(void* hModule, void* hFeature, ref _SV_FEATURE_INFO pInfoOut);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetInfo(void* hModule, void* hFeature, ref _SV_FEATURE_INFO pInfoOut)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueBool_64(void* hModule, void* hFeature, bool* pBoolValue, bool verify = false, bool ignoreCache = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetValueBool", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueBool_32(void* hModule, void* hFeature, bool* pBoolValue, bool verify = false, bool ignoreCache = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetValueBool(void* hModule, void* hFeature, bool* pBoolValue, bool verify = false, bool ignoreCache = false)
            {
		  ...
		  */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueInt64_64(void* hModule, void* hFeature, Int64* pInt64Value, bool verify = false, bool ignoreCache = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetValueInt64", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueInt64_32(void* hModule, void* hFeature, Int64* pInt64Value, bool verify = false, bool ignoreCache = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetValueInt64(void* hModule, void* hFeature, Int64* pInt64Value, bool verify = false, bool ignoreCache = false)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueFloat_64(void* hModule, void* hFeature, double* pFloatValue, bool verify = false, bool ignoreCache = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetValueFloat", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueFloat_32(void* hModule, void* hFeature, double* pFloatValue, bool verify = false, bool ignoreCache = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetValueFloat(void* hModule, void* hFeature, double* pFloatValue, bool verify = false, bool ignoreCache = false)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueString_64(void* hModule, void* hFeature, sbyte* strValue, uint bufferSize, bool verify = false, bool ignoreCache = false);

            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetValueString", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueString_32(void* hModule, void* hFeature, sbyte* strValue, uint bufferSize, bool verify = false, bool ignoreCache = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetValueString(void* hModule, void* hFeature, sbyte* strValue, uint bufferSize, bool verify = false, bool ignoreCache = false)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueInt64Enum_64(void* hModule, void* hFeature, Int64* pInt64Value, bool verify = false, bool ignoreCache = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetValueInt64Enum", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetValueInt64Enum_32(void* hModule, void* hFeature, Int64* pInt64Value, bool verify = false, bool ignoreCache = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetValueInt64Enum(void* hModule, void* hFeature, Int64* pInt64Value, bool verify = false, bool ignoreCache = false)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueBool_64(void* hModule, void* hFeature, bool boolValue, bool verify = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureSetValueBool", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueBool_32(void* hModule, void* hFeature, bool boolValue, bool verify = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureSetValueBool(void* hModule, void* hFeature, bool boolValue, bool verify = false)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueInt64_64(void* hModule, void* hFeature, Int64 int64Value, bool verify = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureSetValueInt64", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueInt64_32(void* hModule, void* hFeature, Int64 int64Value, bool verify = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureSetValueInt64(void* hModule, void* hFeature, Int64 int64Value, bool verify = false)
            {
		  ...
		  */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueFloat_64(void* hModule, void* hFeature, double floatValue, bool verify = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureSetValueFloat", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueFloat_32(void* hModule, void* hFeature, double floatValue, bool verify = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureSetValueFloat(void* hModule, void* hFeature, double floatValue, bool verify = false)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueString_64(void* hModule, void* hFeature, sbyte* strValue, bool verify = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureSetValueString", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueString_32(void* hModule, void* hFeature, sbyte* strValue, bool verify = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureSetValueString(void* hModule, void* hFeature, sbyte* strValue, bool verify = false)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueInt64Enum_64(void* hModule, void* hFeature, Int64 int64Value, bool verify = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureSetValueInt64Enum", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureSetValueInt64Enum_32(void* hModule, void* hFeature, Int64 int64Value, bool verify = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureSetValueInt64Enum(void* hModule, void* hFeature, Int64 int64Value, bool verify = false)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureCommandExecute_64(void* hModule, void* hFeature, uint Timeout, bool bWait = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureCommandExecute", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureCommandExecute_32(void* hModule, void* hFeature, uint Timeout, bool bWait = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureCommandExecute(void* hModule, void* hFeature, uint Timeout, bool bWait = false)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureEnumSubFeatures_64(void* hModule, void* hFeature, int iIndex, sbyte* subFeatureName, uint bufferSize, int* pValue);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureEnumSubFeatures", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureEnumSubFeatures_32(void* hModule, void* hFeature, int iIndex, sbyte* subFeatureName, uint bufferSize, int* pValue);
            internal static unsafe
            SVSVistekApiReturn SVFeatureEnumSubFeatures(void* hModule, void* hFeature, int iIndex, sbyte* subFeatureName, uint bufferSize, int* pValue)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureRegisterInvalidateCB2_64(void* hModule, void* hFeature, Object objCb, [MarshalAs(UnmanagedType.FunctionPtr)] SV_CB_FEATURE_INVALIDATED_PFN2 pfnFeatureInvalidateCb2);
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureRegisterInvalidateCB2_32(void* hModule, void* hFeature, Object objCb, [MarshalAs(UnmanagedType.FunctionPtr)] SV_CB_FEATURE_INVALIDATED_PFN2 pfnFeatureInvalidateCb2);
            internal static unsafe
            SVSVistekApiReturn SVFeatureRegisterInvalidateCB2(void* hModule, void* hFeature, Object objCb, [MarshalAs(UnmanagedType.FunctionPtr)] SV_CB_FEATURE_INVALIDATED_PFN2 pfnFeatureInvalidateCb2)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureUnRegisterInvalidateCB_64(void* hModule, void* hFeature);
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureUnRegisterInvalidateCB_32(void* hModule, void* hFeature);
            internal static unsafe
            SVSVistekApiReturn SVFeatureUnRegisterInvalidateCB(void* hModule, void* hFeature)
            {
		 ...
		 */
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBuffer12BitTo8Bit_64(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVUtilBuffer12BitTo8Bit", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBuffer12BitTo8Bit_32(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            internal static unsafe
            SVSVistekApiReturn SVUtilBuffer12BitTo8Bit(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBuffer12BitTo16Bit_64(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVUtilBuffer12BitTo16Bit", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBuffer12BitTo16Bit_32(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            internal static unsafe
            SVSVistekApiReturn SVUtilBuffer12BitTo16Bit(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBuffer16BitTo8Bit_64(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVUtilBuffer16BitTo8Bit", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBuffer16BitTo8Bit_32(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            internal static unsafe
            SVSVistekApiReturn SVUtilBuffer16BitTo8Bit(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBufferBayerToRGB_64(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVUtilBufferBayerToRGB", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVUtilBufferBayerToRGB_32(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            internal static unsafe
            SVSVistekApiReturn SVUtilBufferBayerToRGB(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVLogRegister_64(byte* moduleName, uint debugLevel);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLogRegister", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
SVSVistekApiReturn SVLogRegister_32(byte* moduleName, uint debugLevel);
            internal static unsafe
            SVSVistekApiReturn SVLogRegister(byte* moduleName, uint debugLevel)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVLogEnableWindbg_64(bool bEnable);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLogEnableWindbg", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVLogEnableWindbg_32(bool bEnable);

            internal static unsafe
            SVSVistekApiReturn SVLogEnableWindbg(bool bEnable)
            {
            ...
            internal static extern unsafe
             SVSVistekApiReturn SVLogEnableFileLogging_64(bool bEnable, byte* logFileName);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLogEnableFileLogging", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
   SVSVistekApiReturn SVLogEnableFileLogging_32(bool bEnable, byte* logFileName);

            internal static unsafe
             SVSVistekApiReturn SVLogEnableFileLogging(bool bEnable, byte* logFileName)
            {
			...
			*/
            ...
            internal static extern unsafe
             SVSVistekApiReturn SVLogSetGlobalDebugLevel_64(uint debugLevel);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLogSetGlobalDebugLevel", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
  SVSVistekApiReturn SVLogSetGlobalDebugLevel_32(uint debugLevel);

            internal static unsafe
             SVSVistekApiReturn SVLogSetGlobalDebugLevel(uint debugLevel)
            {
			...
			*/
            ...
            internal static extern unsafe
             SVSVistekApiReturn SVUtilBufferBayerToRGB32_64(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVUtilBufferBayerToRGB32", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
  SVSVistekApiReturn SVUtilBufferBayerToRGB32_32(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength);

            internal static unsafe
             SVSVistekApiReturn SVUtilBufferBayerToRGB32(_SV_BUFFER_INFO srcInfo, byte* pDest, int pDestLength)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVLibIsVersionCompliant_64(SV_LIB_VERSION expectedVersion, ref SV_LIB_VERSION pCurrentVersion);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVLibIsVersionCompliant", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
  SVSVistekApiReturn SVLibIsVersionCompliant_32(SV_LIB_VERSION expectedVersion, ref SV_LIB_VERSION pCurrentVersion);

            internal static unsafe
             SVSVistekApiReturn SVLibIsVersionCompliant(SV_LIB_VERSION expectedVersion, ref SV_LIB_VERSION pCurrentVersion)
            {
            ...
            internal static extern unsafe
           SVSVistekApiReturn SVFeatureGetValueEnum_64(
            ...
            internal static extern unsafe
           SVSVistekApiReturn SVFeatureGetValueEnum_32(void* hModule, void* hFeature,
                                                   sbyte* buffer, uint bufferSize,
                                                   bool verify = false, bool ignoreCache = false);
            internal static unsafe
            SVSVistekApiReturn SVFeatureGetValueEnum(void* hModule, void* hFeature,
                                                 sbyte* buffer, uint bufferSize,
                                                bool verify = false, bool ignoreCache = false)
            {
			...
			*/
            ...
            internal static extern unsafe
             SVSVistekApiReturn SVFeatureSetValueEnum_64(void* hModule, void* hFeature, sbyte* buffer, bool verify = false);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureSetValueEnum", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
  SVSVistekApiReturn SVFeatureSetValueEnum_32(void* hModule, void* hFeature, sbyte* buffer, bool verify = false);

            internal static unsafe
             SVSVistekApiReturn SVFeatureSetValueEnum(void* hModule, void* hFeature, sbyte* buffer, bool verify = false)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceSaveSettingsToString_64(void* hDevice, sbyte* buffer, uint* pBufferSize);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVDeviceSaveSettingsToString", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceSaveSettingsToString_32(void* hDevice, sbyte* buffer, uint* pBufferSize);

            internal static unsafe
            SVSVistekApiReturn SVDeviceSaveSettingsToString(void* hDevice, sbyte* buffer, uint* pBufferSize)
            {
			...
			*/
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceLoadSettingsFromString_64(void* hDevice, sbyte* buffer);
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVDeviceLoadSettingsFromString_32(void* hDevice, sbyte* buffer);

            internal static unsafe
            SVSVistekApiReturn SVDeviceLoadSettingsFromString(void* hDevice, sbyte* buffer)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureListRefresh_64(void* hModule);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureListRefresh", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureListRefresh_32(void* hModule);

            internal static unsafe
            SVSVistekApiReturn SVFeatureListRefresh(void* hModule)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVUtilSaveImageToPNGFile_64(_SV_BUFFER_INFO info, byte* fileName);
            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVUtilSaveImageToPNGFile", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVUtilSaveImageToPNGFile_32(_SV_BUFFER_INFO info, byte* fileName);

            internal static unsafe
            SVSVistekApiReturn SVUtilSaveImageToPNGFile(_SV_BUFFER_INFO info, byte* fileName)
            {
            ...
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetDescription_64(void* hModule, void* hFeature, sbyte* pBuffer, uint bufferSize);

            [DllImport(DefineConstants.SVGenSDK_DLL, EntryPoint = "SVFeatureGetDescription", CallingConvention = CallingConvention.Cdecl)]
            internal static extern unsafe
            SVSVistekApiReturn SVFeatureGetDescription_32(void* hModule, void* hFeature, sbyte* pBuffer, uint bufferSize);


            internal static unsafe
            SVSVistekApiReturn SVFeatureGetDescription(void* hModule, void* hFeature, sbyte* pBuffer, uint bufferSize)
            {
        ...
        {
            SVSVistekApiReturn ret = SVSVistekApiReturn.SV_ERROR_SUCCESS;
            void* _hSystem = hSystem.ToPointer();
        ...
        {
            void* _hDevice = hDevice.ToPointer();
            sbyte[] bytes = new sbyte[SVSVistek_Api.DefineConstants.SV_STRING_SIZE];
            fixed (sbyte* _pStreamId = bytes)
            {
                fixed (uint* psize = &pSize)
                {
                    SVSVistekApiReturn ret = NativeMethods.SVDeviceGetStreamId(_hDevice, Index, _pStreamId, psize);
        ...
        public unsafe
        SVSVistekApiReturn
         SVS_DeviceRead(IntPtr hDevice, UInt64 nAddress, ref IntPtr pData, ref uint pSize)
        {
            void* _hDevice = hDevice.ToPointer();
        ...
        public unsafe
        SVSVistekApiReturn
        SVS_DeviceWrite(IntPtr hDevice, UInt64 nAddress, sbyte* pData, ref uint pSize)
        {
            void* _hDevice = hDevice.ToPointer();
            fixed (uint* p = &pSize)
            {
       ...
       SVS_UtilBuffer12BitTo16Bit(_SV_BUFFER_INFO srcInfo, ref byte pDest, int pDestLength)
        ...
        public unsafe
        SVSVistekApiReturn
        SVS_UtilBuffer16BitTo8Bit(_SV_BUFFER_INFO srcInfo, ref byte pDest, int pDestLength)
        {
            fixed (byte* pdest = &pDest)
            {
        ...
        SVS_DeviceSaveSettingsToString(IntPtr hDevice, ref string buffer, ref uint pBufferSize)
        {
            ...
            sbyte[] str = null;
            {
                fixed (uint* psize = &pBufferSize)
                {
                    ...
                    if (ret == SVSVistekApiReturn.SV_ERROR_SUCCESS)
                    {
                        str = new sbyte[*psize];
