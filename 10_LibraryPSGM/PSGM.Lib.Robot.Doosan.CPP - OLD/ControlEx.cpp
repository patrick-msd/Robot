...
namespace RCRobotDoosanControl
{
	...
	void Doosan::OnTpInitializingCompletedCB(int id)
	{
		id = _robterId;
		...
		{
			Doosan::ManagedTOnTpInitializingCompletedCBHandler(id);
		}
	};
	...
	void Doosan::OnDisconnected(int id)
	{
		id = _robterId;
		...
		{
			Doosan::ManagedTOnDisconnectedCBHandler(id);
		}
	};
