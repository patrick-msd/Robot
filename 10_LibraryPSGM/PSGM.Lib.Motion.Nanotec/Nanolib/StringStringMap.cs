...
public class StringStringMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          NanolibPINVOKE.delete_StringStringMap(swigCPtr);
        }
  ...
  public StringStringMap() : this(NanolibPINVOKE.new_StringStringMap__SWIG_0(), true) {
  }

  public StringStringMap(StringStringMap other) : this(NanolibPINVOKE.new_StringStringMap__SWIG_1(StringStringMap.getCPtr(other)), true) {
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = NanolibPINVOKE.StringStringMap_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = NanolibPINVOKE.StringStringMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    NanolibPINVOKE.StringStringMap_Clear(swigCPtr);
  }

  private string getitem(string key) {
    string ret = NanolibPINVOKE.StringStringMap_getitem(swigCPtr, key);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    NanolibPINVOKE.StringStringMap_setitem(swigCPtr, key, x);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = NanolibPINVOKE.StringStringMap_ContainsKey(swigCPtr, key);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string value) {
    NanolibPINVOKE.StringStringMap_Add(swigCPtr, key, value);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = NanolibPINVOKE.StringStringMap_Remove(swigCPtr, key);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = NanolibPINVOKE.StringStringMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = NanolibPINVOKE.StringStringMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    NanolibPINVOKE.StringStringMap_destroy_iterator(swigCPtr, swigiterator);
  }
