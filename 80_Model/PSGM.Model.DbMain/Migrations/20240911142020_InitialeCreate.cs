        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", maxLength: 8191, nullable: false),
                    OrderIsDirectory = table.Column<bool>(type: "INTEGER", nullable: false),
                    Status = table.Column<uint>(type: "INTEGER", maxLength: 1023, nullable: false),
                    DocumentObjectName = table.Column<string>(type: "TEXT", maxLength: 1023, nullable: false),
                    ProcessingStartedDateTime = table.Column<DateTime>(type: "TEXT", maxLength: 1023, nullable: false),
                    ProcessingStartedUserIdExt = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProcessingFinishedDateTime = table.Column<DateTime>(type: "TEXT", maxLength: 1023, nullable: false),
                    ProcessingFinishedUserIdExt = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostDirectory_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreDirectory_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id");
                    table.ForeignKey(
