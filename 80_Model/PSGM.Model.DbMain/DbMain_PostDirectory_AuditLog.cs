...
{
    [Table("PostDirectory_AuditLog")]
    public class DbMain_PostDirectory_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_PostDirectory GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_PostDirectory>(Changes);
        }
        #endregion
    }
}
