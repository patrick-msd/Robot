...
{
    [Table("Archive_Job_Link_AuditLog")]
    public class DbMain_Archive_Job_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Archive_Job_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Archive_Job_Link>(Changes);
        }
        #endregion
    }
}
