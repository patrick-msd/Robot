...
{
    [Table("Archive_Job_AuditLog")]
    public class DbMain_Archive_Job_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Archive_Job? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Archive_Job>(Changes);
        }
        #endregion
    }
}
