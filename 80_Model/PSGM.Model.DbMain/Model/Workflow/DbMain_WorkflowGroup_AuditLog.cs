...
{
    [Table("WorkflowGroup_AuditLog")]
    public class DbMain_WorkflowGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_WorkflowGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_WorkflowGroup>(Changes);
        }
        #endregion
    }
}
