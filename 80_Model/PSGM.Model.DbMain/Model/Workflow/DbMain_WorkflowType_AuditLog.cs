...
{
    [Table("WorkflowType_AuditLog")]
    public class DbMain_WorkflowType_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_WorkflowType? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_WorkflowType>(Changes);
        }
        #endregion
    }
}
