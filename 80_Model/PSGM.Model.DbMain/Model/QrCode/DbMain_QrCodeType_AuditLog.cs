...
{
    [Table("QrCodeType_AuditLog")]
    public class DbMain_QrCodeType_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_QrCodeType? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_QrCodeType>(Changes);
        }
        #endregion
    }
}
