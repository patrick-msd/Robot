...
namespace PSGM.Model.DbMain
{
    ...
    public class DbMain_Location_Address_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Location_Address_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Location_Address_Link>(Changes);
        }
        #endregion
    }
}
