...
{
    [Table("Unit_Defect_AuditLog")]
    public class DbMain_Unit_Defect_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Unit_Defect? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Unit_Defect>(Changes);
        }
        #endregion
    }
}
