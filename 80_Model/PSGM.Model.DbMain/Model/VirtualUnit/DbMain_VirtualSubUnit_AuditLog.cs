...
{
    [Table("VirtualSubUnit_AuditLog")]
    public class DbMain_VirtualSubUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_VirtualSubUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_VirtualSubUnit>(Changes);
        }
        #endregion
    }
}
