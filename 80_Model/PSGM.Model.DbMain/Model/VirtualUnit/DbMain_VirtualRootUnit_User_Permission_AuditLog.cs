...
{
    [Table("VirtualRootUnit_User_Permission_AuditLog")]
    public class DbMain_VirtualRootUnit_User_Permission_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_VirtualRootUnit_User_Permission? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_VirtualRootUnit_User_Permission>(Changes);
        }
        #endregion
    }
}
