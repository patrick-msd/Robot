...
{
    [Table("VirtualRootUnit_AuditLog")]
    public class DbMain_VirtualRootUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_VirtualRootUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_VirtualRootUnit>(Changes);
        }
        #endregion
    }
}
