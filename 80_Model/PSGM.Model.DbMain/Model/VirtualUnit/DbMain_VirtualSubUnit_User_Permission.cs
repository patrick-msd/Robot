...
namespace PSGM.Model.DbMain
{
    ...
    public class DbMain_VirtualSubUnit_User_Permission
    {
        #region Entities
        [Key]
        [Required]
        ...
        [Column("PermissionSubUnit")]
        [Display(Name = "PermissionSubUnit")]
        public PermissionType PermissionSubUnit { get; set; } = PermissionType.None;
        ...
        public virtual DbMain_VirtualSubUnit? SubUnit { get; set; }
        #endregion
