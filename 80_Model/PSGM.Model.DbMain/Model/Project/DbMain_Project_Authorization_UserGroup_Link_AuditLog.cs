...
{
    [Table("Project_Authorization_UserGroup_Link_AuditLog")]
    public class DbMain_Project_Authorization_UserGroup_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Project_Authorization_UserGroup_Link GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Project_Authorization_UserGroup_Link>(Changes);
        }
        #endregion
    }
}
