...
{
    [Table("Project_Notification_UserGroup_AuditLog")]
    public class DbMain_Project_Notification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Project_Notification_UserGroup GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Project_Notification_UserGroup>(Changes);
        }
        #endregion
    }
}
