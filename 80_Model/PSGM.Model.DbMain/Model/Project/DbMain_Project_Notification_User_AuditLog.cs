...
{
    [Table("Project_Notification_User_AuditLog")]
    public class DbMain_Project_Notification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Project_Notification_User GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Project_Notification_User>(Changes);
        }
        #endregion
    }
}
