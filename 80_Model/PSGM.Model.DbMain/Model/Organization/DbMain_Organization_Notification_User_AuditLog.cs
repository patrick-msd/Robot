...
{
    [Table("Organization_Notification_User_AuditLog")]
    public class DbMain_Organization_Notification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Organization_Notification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_Organization_Notification_User>(Changes);
        }
        #endregion
    }
}
