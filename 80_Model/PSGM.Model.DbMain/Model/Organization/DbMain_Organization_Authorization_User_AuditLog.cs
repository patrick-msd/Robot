...
{
    [Table("Organization_Authorization_User_AuditLog")]
    public class DbMain_Organization_Authorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        {
            return JsonConvert.DeserializeObject<DbMain_Organization_Authorization_User>(Changes);
        }
        #endregion
    }
}
