...
{
    [Table("Organization_AuditLog")]
    public class DbMain_Organization_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Organization GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Organization>(Changes);
        }
        #endregion
    }
}
