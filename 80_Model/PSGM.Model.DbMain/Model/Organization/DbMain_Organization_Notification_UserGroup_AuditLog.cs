...
{
    [Table("Organization_Notification_UserGroup_AuditLog")]
    public class DbMain_Organization_Notification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Organization_Notification_UserGroup GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Organization_Notification_UserGroup>(Changes);
        }
        #endregion
    }
}
