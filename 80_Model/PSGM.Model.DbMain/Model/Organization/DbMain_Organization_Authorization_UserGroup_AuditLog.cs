...
{
    [Table("Organization_Authorization_UserGroup_AuditLog")]
    public class DbMain_Organization_Authorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Organization_Authorization_UserGroup GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Organization_Authorization_UserGroup>(Changes);
        }
        #endregion
    }
}
