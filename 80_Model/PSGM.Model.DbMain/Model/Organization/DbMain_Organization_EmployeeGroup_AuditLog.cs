...
{
    [Table("Organization_EmployeeGroup_AuditLog")]
    public class DbMain_Organization_EmployeeGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Organization_EmployeeGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Organization_EmployeeGroup>(Changes);
        }
        #endregion
    }
}
