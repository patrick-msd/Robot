...
{
    [Table("Organization_Employee_Notification_AuditLog")]
    public class DbMain_Organization_Employee_Notification_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_Organization_Employee_Notification GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMain_Organization_Employee_Notification>(Changes);
        }
        #endregion
    }
}
