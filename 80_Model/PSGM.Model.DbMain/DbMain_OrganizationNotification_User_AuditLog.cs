...
{
    [Table("Organizationotification_User_AuditLog")]
    public class DbMain_OrganizationNotification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_OrganizationNotification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_OrganizationNotification_User>(Changes);
        }
        #endregion
    }
}
