...
{
    [Table("OrganizationAuthorization_UserGroup_AuditLog")]
    public class DbMain_OrganizationAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_OrganizationAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_OrganizationAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
