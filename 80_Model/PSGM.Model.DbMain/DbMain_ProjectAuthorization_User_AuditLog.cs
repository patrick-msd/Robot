...
{
    [Table("ProjectAuthorization_User_AuditLog")]
    public class DbMain_ProjectAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_ProjectAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_ProjectAuthorization_User>(Changes);
        }
        #endregion
    }
}
