...
namespace PSGM.Model.DbMain
{
    ...
    public class DbMain_ProjectParameterStorage_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_ProjectParameterStorage GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_ProjectParameterStorage>(Changes);
        }
        #endregion
    }
}
