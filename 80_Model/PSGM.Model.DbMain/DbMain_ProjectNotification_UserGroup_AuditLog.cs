...
{
    [Table("ProjectNotification_UserGroup_AuditLog")]
    public class DbMain_ProjectNotification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_ProjectNotification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_ProjectNotification_UserGroup>(Changes);
        }
        #endregion
    }
}
