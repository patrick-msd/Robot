...
{
    [Table("ProjectNotification_User_AuditLog")]
    public class DbMain_ProjectNotification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_ProjectNotification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_ProjectNotification_User>(Changes);
        }
        #endregion
    }
}
