...
{
    [Table("DeliveryBillTemplate_AuditLog")]
    public class DbMain_DeliveryBillTemplate_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_DeliveryBillTemplate GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_DeliveryBillTemplate>(Changes);
        }
        #endregion
    }
}
