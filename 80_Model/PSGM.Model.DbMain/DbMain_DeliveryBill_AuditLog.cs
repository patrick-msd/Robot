...
{
    [Table("DeliveryBill_AuditLog")]
    public class DbMain_DeliveryBill_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_DeliveryBill GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_DeliveryBill>(Changes);
        }
        #endregion
    }
}
