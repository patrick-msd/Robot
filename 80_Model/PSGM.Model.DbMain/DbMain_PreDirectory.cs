...
{
    [Table("PreDirectory")]
    public class DbMain_PreDirectory
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbMain_PreDirectory>? SubDirectories { get; set; }
        #endregion
        ...
        public virtual DbMain_PreDirectory? ParentSubDirectory { get; set; }
        #endregion
