...
{
    [Table("OrganizationAuthorization_User_AuditLog")]
    public class DbMain_OrganizationAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_OrganizationAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_OrganizationAuthorization_User>(Changes);
        }
        #endregion
    }
}
