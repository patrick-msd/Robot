...
{
    [Table("ProjectAuthorization_UserGroup_AuditLog")]
    public class DbMain_ProjectAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_ProjectAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_ProjectAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
