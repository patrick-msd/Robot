...
{
    [Table("OrganizationNotification_UserGroup_AuditLog")]
    public class DbMain_OrganizationNotification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_OrganizationNotification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_OrganizationNotification_UserGroup>(Changes);
        }
        #endregion
    }
}
