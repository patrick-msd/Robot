...
{
    [Table("DeliverySlip_AuditLog")]
    public class DbMain_DeliverySlip_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_DeliverySlip GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_DeliverySlip>(Changes);
        }
        #endregion
    }
}
