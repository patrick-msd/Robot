...
{
    [Table("ProjectParameter_AuditLog")]
    public class DbMain_ProjectParameter_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMain_ProjectParameter GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMain_ProjectParameter>(Changes);
        }
        #endregion
    }
}
