...
{
    [Table("Database_Server_AuditLog")]
    public class DbBackend_Database_Server_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Database_Server? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Database_Server>(Changes);
        }
        #endregion
    }
}
