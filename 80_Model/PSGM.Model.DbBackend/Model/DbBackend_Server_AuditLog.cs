...
{
    [Table("Server_AuditLog")]
    public class DbBackend_Server_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Server? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Server>(Changes);
        }
        #endregion
    }
}
