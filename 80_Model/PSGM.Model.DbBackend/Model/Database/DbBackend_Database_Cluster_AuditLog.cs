...
{
    [Table("Database_Cluster_AuditLog")]
    public class DbBackend_Database_Cluster_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Database_Cluster? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Database_Cluster>(Changes);
        }
        #endregion
    }
}
