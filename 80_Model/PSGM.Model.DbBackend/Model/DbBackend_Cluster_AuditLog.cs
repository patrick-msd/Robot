...
{
    [Table("Cluster_AuditLog")]
    public class DbBackend_Cluster_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Cluster? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Cluster>(Changes);
        }
        #endregion
    }
}
