...
{
    [Table("Storage_Server_AuditLog")]
    public class DbBackend_Storage_Server_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Storage_Server? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Storage_Server>(Changes);
        }
        #endregion
    }
}
