...
{
    [Table("Backend_AuditLog")]
    public class DbBackend_Backend_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Backend? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Backend>(Changes);
        }
        #endregion
    }
}
