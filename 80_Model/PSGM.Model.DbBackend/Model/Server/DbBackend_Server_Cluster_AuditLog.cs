...
{
    [Table("Server_Cluster_AuditLog")]
    public class DbBackend_Server_Cluster_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Server_Cluster? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Server_Cluster>(Changes);
        }
        #endregion
    }
}
