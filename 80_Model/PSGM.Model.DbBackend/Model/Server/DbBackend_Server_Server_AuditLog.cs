...
{
    [Table("Server_Server_AuditLog")]
    public class DbBackend_Server_Server_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Server_Server? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Server_Server>(Changes);
        }
        #endregion
    }
}
