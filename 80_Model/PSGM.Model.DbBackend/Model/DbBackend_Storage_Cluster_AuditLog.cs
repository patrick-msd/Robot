...
{
    [Table("Storage_Cluster_AuditLog")]
    public class DbBackend_Storage_Cluster_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackend_Storage_Cluster? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackend_Storage_Cluster>(Changes);
        }
        #endregion
    }
}
