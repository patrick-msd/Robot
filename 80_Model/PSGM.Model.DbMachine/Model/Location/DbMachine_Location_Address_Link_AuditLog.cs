...
{
    [Table("Location_Address_Link_AuditLog")]
    public class DbMachine_Location_Address_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Location_Address_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Location_Address_Link>(Changes);
        }
        #endregion
    }
}
