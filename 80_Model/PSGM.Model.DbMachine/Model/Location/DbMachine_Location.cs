...
namespace PSGM.Model.DbMachine
{
    ...
    public class DbMachine_Location
    {
        ...
        public virtual DbMachine_Location_Address_Link? AddressLink { get; set; }

        [InverseProperty("Location")]
        public virtual ICollection<DbMachine_Machine_Location_Link>? MachineLocationLink { get; set; }
        #endregion
