...
{
    [Table("DeviceGroup_AuditLog")]
    public class DbMachine_DeviceGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_DeviceGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_DeviceGroup>(Changes);
        }
        #endregion
    }
}
