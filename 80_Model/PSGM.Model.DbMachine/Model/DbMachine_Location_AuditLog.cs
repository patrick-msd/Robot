...
{
    [Table("Location_AuditLog")]
    public class DbMachine_Location_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Location GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Location>(Changes);
        }
        #endregion
    }
}
