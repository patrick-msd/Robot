...
{
    [Table("Machine_AuditLog")]
    public class DbMachine_Machine_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Machine? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Machine>(Changes);
        }
        #endregion
    }
}
