...
{
    [Table("Machine_Project_Link_AuditLog")]
    public class DbMachine_Machine_Project_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Machine_Project_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Machine_Project_Link>(Changes);
        }
        #endregion
    }
}
