...
{
    [Table("Machine_Location_Link_AuditLog")]
    public class DbMachine_Machine_Location_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Machine_Location_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Machine_Location_Link>(Changes);
        }
        #endregion
    }
}
