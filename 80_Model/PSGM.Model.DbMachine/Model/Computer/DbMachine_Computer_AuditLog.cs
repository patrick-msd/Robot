...
{
    [Table("Computer_AuditLog")]
    public class DbMachine_Computer_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Computer? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Computer>(Changes);
        }
        #endregion
    }
}
