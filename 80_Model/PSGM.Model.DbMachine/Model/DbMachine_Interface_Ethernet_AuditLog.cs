...
{
    [Table("Interface_Ethernet_AuditLog")]
    public class DbMachine_Interface_Ethernet_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Interface_Ethernet GetChanges()
        {
            return JsonConvert.DeserializeObject<DbMachine_Interface_Ethernet>(Changes);
        }
        #endregion
    }
}
