...
{
    [Table("Interface_Can_AuditLog")]
    public class DbMachine_Interface_Can_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Interface_Can GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMachine_Interface_Can>(Changes);
        }
        #endregion
    }
}
