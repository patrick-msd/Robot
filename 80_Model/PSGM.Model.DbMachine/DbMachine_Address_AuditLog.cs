...
{
    [Table("Adderss_AuditLog")]
    public class DbMachine_Address_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Address GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMachine_Address>(Changes);
        }
        #endregion
    }
}
