...
{
    [Table("Interface_Serial_AuditLog")]
    public class DbMachine_Interface_Serial_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbMachine_Interface_Serial GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbMachine_Interface_Serial>(Changes);
        }
        #endregion
    }
}
