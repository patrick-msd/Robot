        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObjectsAutofill = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RootDirectoryMetadata_RootDirectory_RootDirectoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationUserIdsExtString = table.Column<string>(type: "character varying(16383)", maxLength: 16383, nullable: false),
                    NotificationUserGroupIdsExtString = table.Column<string>(type: "character varying(16383)", maxLength: 16383, nullable: false),
                    ObjectMetadataString = table.Column<string>(type: "character varying(16383)", maxLength: 16383, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubDirectoryMetadata_SubDirectory_SubDirectoryId",
                        column: x => x.SubDirectoryId,
                        principalSchema: "psgm",
                        principalTable: "SubDirectory",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RootDirectoryMetadata_RootDirectoryId",
                schema: "psgm",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubDirectoryMetadata_SubDirectoryId",
                schema: "psgm",
                table: "SubDirectoryMetadata",
                column: "SubDirectoryId");
