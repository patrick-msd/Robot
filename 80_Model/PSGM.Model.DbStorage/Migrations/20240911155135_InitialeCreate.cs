...
namespace PSGM.Model.DbStorage.Migrations
{
    ...
    public partial class InitialeCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FileMetadataNotification_User_AuditLog",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    SourceId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileMetadataNotification_User_AuditLog", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "FileMetadataNotification_UserGroup_AuditLog",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    SourceId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileMetadataNotification_UserGroup_AuditLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ExtId1 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId2 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId3 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId4 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId5 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId6 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId7 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId8 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId9 = table.Column<string>(type: "TEXT", nullable: false),
                    ExtId10 = table.Column<string>(type: "TEXT", nullable: false),
                    Suffix = table.Column<string>(type: "TEXT", maxLength: 127, nullable: false),
                    ...
                    StorageObjectUrl = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: false),
                    ...
                    ModifiedDateTimeAutoFill = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ModifiedByUserIdExtAutoFill = table.Column<Guid>(type: "TEXT", nullable: false),
                    LastModificationChangesAutoFill = table.Column<string>(type: "TEXT", maxLength: 8191, nullable: false),
                    RootDirectoryId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Metadata = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 8191, nullable: false),
                    CreatedDateTimeAutoFill = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedByUserIdExtAutoFill = table.Column<Guid>(type: "TEXT", nullable: false),
                    ModifiedDateTimeAutoFill = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Permissions = table.Column<int>(type: "INTEGER", nullable: false),
                    UserIdExt = table.Column<Guid>(type: "TEXT", nullable: false),
                    FileMetadataId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileMetadataAuthorization_User", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileMetadataAuthorization_User_FileMetadata_FileMetadataId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileMetadataAuthorization_UserGroup_FileMetadata_FileMetadataId",
                        column: x => x.FileMetadataId,
                        principalTable: "FileMetadata",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "FileMetadataNotification_UserGroup",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 16384, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileMetadataNotification_UserGroup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileMetadataNotification_UserGroup_FileMetadata_FileMetadataId",
                        column: x => x.FileMetadataId,
                        principalTable: "FileMetadata",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "FilMetadataNotification_User",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 16384, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilMetadataNotification_User", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FilMetadataNotification_User_FileMetadata_FileMetadataId",
                        column: x => x.FileMetadataId,
                        principalTable: "FileMetadata",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileMetadataAuthorization_User_FileMetadataId",
                table: "FileMetadataAuthorization_User",
                column: "FileMetadataId");

            migrationBuilder.CreateIndex(
                name: "IX_FileMetadataAuthorization_UserGroup_FileMetadataId",
                table: "FileMetadataAuthorization_UserGroup",
                column: "FileMetadataId");

            migrationBuilder.CreateIndex(
                name: "IX_FileMetadataNotification_UserGroup_FileMetadataId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilMetadataNotification_User_FileMetadataId",
                table: "FilMetadataNotification_User",
                column: "FileMetadataId");
