        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetadataType = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "RootDirectory_Notification_UserLink_AuditLog",
                schema: "psgm",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RootDirectory_Notification_UserLink_AuditLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RootDirectory_Notification_UserLink",
                schema: "psgm",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RootDirectory_Notification_UserLink", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RootDirectory_Notification_UserLink_RootDirectory_Notificat~",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RootDirectory_Notification_UserLink_RootDirectory_RootDirec~",
                        column: x => x.RootDirectoryId,
                        principalSchema: "psgm",
                        principalTable: "RootDirectory",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                name: "RootDirectory_Notification_UserGroupLink",
                schema: "psgm",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RootDirectory_Notification_UserGroupLink", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RootDirectory_Notification_UserGroupLink_RootDirectory_Noti~",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RootDirectory_Notification_UserGroupLink_RootDirectory_Root~",
                        column: x => x.RootDirectoryId,
                        principalSchema: "psgm",
                        principalTable: "RootDirectory",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RootDirectory_Notification_UserGroupLink_NotificationUserGr~",
                schema: "psgm",
                table: "RootDirectory_Notification_UserGroupLink",
                column: "NotificationUserGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_RootDirectory_Notification_UserGroupLink_RootDirectoryId",
                schema: "psgm",
                table: "RootDirectory_Notification_UserGroupLink",
                column: "RootDirectoryId");

            migrationBuilder.CreateIndex(
                name: "IX_RootDirectory_Notification_UserLink_NotificationUserId",
                schema: "psgm",
                table: "RootDirectory_Notification_UserLink",
                column: "NotificationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RootDirectory_Notification_UserLink_RootDirectoryId",
                schema: "psgm",
                table: "RootDirectory_Notification_UserLink",
                column: "RootDirectoryId");
