...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectoryAuthorization_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Links
        [InverseProperty("RootDirectoryAuthorization_User")]
        public virtual ICollection<DbStorage_RootDirectoryAuthorization_UserLink>? RootDirectoryAuthorization_UserLinks { get; set; }
        #endregion
