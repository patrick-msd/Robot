...
{
    [Table("FileNotification_UserGroupLink_AuditLog")]
    public class DbStorage_FileNotification_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileNotification_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileNotification_UserGroupLink>(Changes);
        }
        #endregion
    }
}
