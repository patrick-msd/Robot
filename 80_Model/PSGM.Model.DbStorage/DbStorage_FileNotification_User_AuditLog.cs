...
{
    [Table("FileNotification_User_AuditLog")]
    public class DbStorage_FileNotification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileNotification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileNotification_User>(Changes);
        }
        #endregion
    }
}
