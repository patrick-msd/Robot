...
{
    [Table("SubDirectoryMetadataAuthorization_UserLink_AuditLog")]
    public class DbStorage_SubDirectoryMetadataAuthorization_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryMetadataAuthorization_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryMetadataAuthorization_UserLink>(Changes);
        }
        #endregion
    }
}
