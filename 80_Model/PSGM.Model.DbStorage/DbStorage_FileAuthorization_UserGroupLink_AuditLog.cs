...
{
    [Table("FileAuthorization_UserGroupLink_AuditLog")]
    public class DbStorage_FileAuthorization_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileAuthorization_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileAuthorization_UserGroupLink>(Changes);
        }
        #endregion
    }
}
