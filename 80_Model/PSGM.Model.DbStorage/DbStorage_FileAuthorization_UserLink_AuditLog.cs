...
{
    [Table("FileAuthorization_UserLink_AuditLog")]
    public class DbStorage_FileAuthorization_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileAuthorization_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileAuthorization_UserLink>(Changes);
        }
        #endregion
    }
}
