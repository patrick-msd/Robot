...
{
    [Table("RootDirectoryNotification_UserGroup_AuditLog")]
    public class DbStorage_RootDirectoryNotification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryNotification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryNotification_UserGroup>(Changes);
        }
        #endregion
    }
}
