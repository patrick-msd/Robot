...
{
    [Table("SubDirectoryAuthorization_UserGroup_AuditLog")]
    public class DbStorage_SubDirectoryAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
