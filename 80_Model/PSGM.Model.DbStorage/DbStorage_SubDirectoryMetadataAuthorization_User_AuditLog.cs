...
{
    [Table("SubDirectoryMetadataAuthorization_User_AuditLog")]
    public class DbStorage_SubDirectoryMetadataAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryMetadataAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryMetadataAuthorization_User>(Changes);
        }
        #endregion
    }
}
