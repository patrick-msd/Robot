...
{
    [Table("FileMetadataAuthorization_UserLink_AuditLog")]
    public class DbStorage_FileMetadataAuthorization_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileMetadataAuthorization_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileMetadataAuthorization_UserLink>(Changes);
        }
        #endregion
    }
}
