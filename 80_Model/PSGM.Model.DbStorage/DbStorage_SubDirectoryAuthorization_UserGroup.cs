...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_SubDirectoryAuthorization_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Links
        [InverseProperty("SubDirectoryAuthorization_UserGroup")]
        public virtual ICollection<DbStorage_SubDirectoryAuthorization_UserGroupLink>? SubDirectoryAuthorization_UserGroupLinks { get; set; }
        #endregion
