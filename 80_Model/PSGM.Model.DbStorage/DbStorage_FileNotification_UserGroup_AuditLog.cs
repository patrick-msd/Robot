...
{
    [Table("FileNotification_UserGroup_AuditLog")]
    public class DbStorage_FileNotification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileNotification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileNotification_UserGroup>(Changes);
        }
        #endregion
    }
}
