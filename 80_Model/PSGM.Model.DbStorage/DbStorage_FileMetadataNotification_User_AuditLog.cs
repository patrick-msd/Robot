...
{
    [Table("FileMetadataNotification_User_AuditLog")]
    public class DbStorage_FileMetadataNotification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileMetadataNotification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileMetadataNotification_User>(Changes);
        }
        #endregion
    }
}
