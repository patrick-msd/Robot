...
{
    [Table("SubDirectory_AuditLog")]
    public class DbStorage_SubDirectory_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory>(Changes);
        }
        #endregion
    }
}
