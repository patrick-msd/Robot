...
{
    [Table("SubDirectoryMetadataLink_AuditLog")]
    public class DbStorage_SubDirectoryMetadataLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryMetadataLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryMetadataLink>(Changes);
        }
        #endregion
    }
}
