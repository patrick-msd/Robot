...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_SubDirectoryNotification_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Links
        [InverseProperty("SubDirectoryNotification_UserGroup")]
        public virtual ICollection<DbStorage_SubDirectoryNotification_UserGroupLink>? SubDirectoryNotification_UserGroupLinks { get; set; }
        #endregion
