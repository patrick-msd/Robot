...
{
    [Table("FileMetadataNotification_UserGroup_AuditLog")]
    public class DbStorage_FileMetadataNotification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileMetadataNotification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileMetadataNotification_UserGroup>(Changes);
        }
        #endregion
    }
}
