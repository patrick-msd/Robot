...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectoryNotification_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Links
        [InverseProperty("RootDirectoryNotification_UserGroup")]
        public virtual ICollection<DbStorage_RootDirectoryNotification_UserGroupLink>? RootDirectoryNotification_UserGroupLinks { get; set; }
        #endregion
