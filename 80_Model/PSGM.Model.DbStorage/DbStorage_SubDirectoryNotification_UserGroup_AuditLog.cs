...
{
    [Table("SubDirectoryNotification_UserGroup_AuditLog")]
    public class DbStorage_SubDirectoryNotification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryNotification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryNotification_UserGroup>(Changes);
        }
        #endregion
    }
}
