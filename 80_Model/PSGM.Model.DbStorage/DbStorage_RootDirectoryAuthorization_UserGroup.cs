...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectoryAuthorization_UserGroup
    {
        ...
        #region Links
        [InverseProperty("RootDirectoryAuthorization_UserGroup")]
        public virtual ICollection<DbStorage_RootDirectoryAuthorization_UserGroupLink>? RootDirectoryAuthorization_UserGroupLinks { get; set; }
        #endregion
