...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_SubDirectoryAuthorization_User
    {
        ...
        #region Links
        [InverseProperty("SubDirectoryAuthorization_User")]
        public virtual ICollection<DbStorage_SubDirectoryAuthorization_UserLink>? SubDirectoryAuthorization_UserLinks { get; set; }
        #endregion
