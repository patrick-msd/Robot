...
{
    [Table("FileAuthorization_User_AuditLog")]
    public class DbStorage_FileAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileAuthorization_User>(Changes);
        }
        #endregion
    }
}
