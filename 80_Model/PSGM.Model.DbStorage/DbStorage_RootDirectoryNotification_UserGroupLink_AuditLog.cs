...
{
    [Table("RootDirectoryNotification_UserGroupLink_AuditLog")]
    public class DbStorage_RootDirectoryNotification_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryNotification_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryNotification_UserGroupLink>(Changes);
        }
        #endregion
    }
}
