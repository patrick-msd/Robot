...
{
    [Table("SubDirectoryParameterStorage_AuditLog")]
    public class DbStorage_SubDirectoryParameterStorage_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryParameterStorage GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryParameterStorage>(Changes);
        }
        #endregion
    }
}
