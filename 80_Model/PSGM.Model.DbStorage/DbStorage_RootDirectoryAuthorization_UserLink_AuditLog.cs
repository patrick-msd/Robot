...
{
    [Table("RootDirectoryAuthorization_UserLink_AuditLog")]
    public class DbStorage_RootDirectoryAuthorization_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryAuthorization_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryAuthorization_UserLink>(Changes);
        }
        #endregion
    }
}
