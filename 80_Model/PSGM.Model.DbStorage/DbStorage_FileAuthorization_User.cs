...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_FileAuthorization_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Links
        [InverseProperty("FileAuthorization_User")]
        public virtual ICollection<DbStorage_FileAuthorization_UserLink>? FileAuthorization_UserLinks { get; set; }
        #endregion
