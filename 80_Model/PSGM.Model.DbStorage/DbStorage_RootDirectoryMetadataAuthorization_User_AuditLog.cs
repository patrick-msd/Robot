...
{
    [Table("RootDirectoryMetadataAuthorization_User_AuditLog")]
    public class DbStorage_RootDirectoryMetadataAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryMetadataAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryMetadataAuthorization_User>(Changes);
        }
        #endregion
    }
}
