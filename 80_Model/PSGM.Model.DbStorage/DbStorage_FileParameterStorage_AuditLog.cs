...
{
    [Table("FileParameterStorage_AuditLog")]
    public class DbStorage_FileParameterStorage_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileParameterStorage GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileParameterStorage>(Changes);
        }
        #endregion
    }
}
