...
{
    [Table("RootDirectoryNotification_UserLink_AuditLog")]
    public class DbStorage_RootDirectoryNotification_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryNotification_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryNotification_UserLink>(Changes);
        }
        #endregion
    }
}
