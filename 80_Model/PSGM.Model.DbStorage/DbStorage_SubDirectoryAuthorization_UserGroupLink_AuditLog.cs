...
{
    [Table("SubDirectoryAuthorization_UserGroupLink_AuditLog")]
    public class DbStorage_SubDirectoryAuthorization_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryAuthorization_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryAuthorization_UserGroupLink>(Changes);
        }
        #endregion
    }
}
