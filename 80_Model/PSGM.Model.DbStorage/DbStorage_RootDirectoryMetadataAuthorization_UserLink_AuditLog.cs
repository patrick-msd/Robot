...
{
    [Table("RootDirectoryMetadataAuthorization_UserLink_AuditLog")]
    public class DbStorage_RootDirectoryMetadataAuthorization_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryMetadataAuthorization_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryMetadataAuthorization_UserLink>(Changes);
        }
        #endregion
    }
}
