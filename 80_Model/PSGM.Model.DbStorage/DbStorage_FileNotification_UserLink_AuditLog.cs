...
{
    [Table("FileNotification_UserLink_AuditLog")]
    public class DbStorage_FileNotification_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileNotification_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileNotification_UserLink>(Changes);
        }
        #endregion
    }
}
