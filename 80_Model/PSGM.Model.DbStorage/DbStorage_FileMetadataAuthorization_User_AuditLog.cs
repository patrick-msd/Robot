...
{
    [Table("FileMetadataAuthorization_User_AuditLog")]
    public class DbStorage_FileMetadataAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileMetadataAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileMetadataAuthorization_User>(Changes);
        }
        #endregion
    }
}
