...
{
    [Table("RootDirectoryMetadataLink_AuditLog")]
    public class DbStorage_RootDirectoryMetadataLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileMetadata GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileMetadata>(Changes);
        }
        #endregion
    }
}
