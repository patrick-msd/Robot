...
{
    [Table("FileQuality_AuditLog")]
    public class DbStorage_Quality_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_Quality GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_Quality>(Changes);
        }
        #endregion
    }
}
