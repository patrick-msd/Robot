...
{
    [Table("SubDirectoryAuthorization_UserLink_AuditLog")]
    public class DbStorage_SubDirectoryAuthorization_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryAuthorization_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryAuthorization_UserLink>(Changes);
        }
        #endregion
    }
}
