...
{
    [Table("SubDirectoryNotification_UserLink_AuditLog")]
    public class DbStorage_SubDirectoryNotification_UserLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryNotification_UserLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryNotification_UserLink>(Changes);
        }
        #endregion
    }
}
