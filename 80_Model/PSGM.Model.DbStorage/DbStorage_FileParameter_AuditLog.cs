...
{
    [Table("FileParameter_AuditLog")]
    public class DbStorage_FileParameter_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileParameter GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileParameter>(Changes);
        }
        #endregion
    }
}
