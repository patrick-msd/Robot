...
{
    [Table("RootDirectoryParameter_AuditLog")]
    public class DbStorage_RootDirectoryParameter_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryParameter GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryParameter>(Changes);
        }
        #endregion
    }
}
