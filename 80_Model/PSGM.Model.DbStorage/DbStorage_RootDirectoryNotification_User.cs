...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectoryNotification_User
    {
        ...
        #region Links
        [InverseProperty("RootDirectoryNotification_User")]
        public virtual ICollection<DbStorage_RootDirectoryNotification_UserLink>? RootDirectoryNotification_UserLinks { get; set; }
        #endregion
