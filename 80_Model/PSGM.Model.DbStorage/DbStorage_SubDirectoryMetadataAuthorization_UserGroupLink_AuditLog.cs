...
{
    [Table("SubDirectoryMetadataAuthorization_UserGroupLink_AuditLog")]
    public class DbStorage_SubDirectoryMetadataAuthorization_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryMetadataAuthorization_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryMetadataAuthorization_UserGroupLink>(Changes);
        }
        #endregion
    }
}
