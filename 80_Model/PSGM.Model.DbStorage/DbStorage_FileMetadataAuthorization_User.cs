...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_FileMetadataAuthorization_User
    {
        ...
        #region Links
        [InverseProperty("FileMetadataAuthorization_User")]
        public virtual ICollection<DbStorage_FileMetadataAuthorization_UserLink>? FileMetadataAuthorization_UserLinks { get; set; }
        #endregion
