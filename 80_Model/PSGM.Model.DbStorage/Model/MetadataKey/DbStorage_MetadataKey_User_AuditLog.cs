...
{
    [Table("MetadataKey_User_AuditLog")]
    public class DbStorage_MetadataKey_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_MetadataKey_User? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_MetadataKey_User>(Changes);
        }
        #endregion
    }
}
