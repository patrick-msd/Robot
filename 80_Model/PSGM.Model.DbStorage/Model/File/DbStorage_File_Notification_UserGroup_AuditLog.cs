...
{
    [Table("File_Notification_UserGroup_AuditLog")]
    public class DbStorage_File_Notification_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Notification_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Notification_UserGroup>(Changes);
        }
        #endregion
    }
}
