...
{
    [Table("File_VirtualUnit_User")]
    public class DbStorage_File_VirtualUnit_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_File_VirtualUnit_User_Notification>? Notifications { get; set; }

        [InverseProperty("User")]
        public virtual DbStorage_File_VirtualUnit_User_Permission? Permissions { get; set; }

        [InverseProperty("User")]
        public virtual ICollection<DbStorage_File_VirtualUnit_User_Link>? UserLinks { get; set; }
        #endregion
