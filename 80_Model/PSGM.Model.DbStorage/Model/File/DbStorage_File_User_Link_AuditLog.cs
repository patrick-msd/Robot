...
{
    [Table("File_User_Link_AuditLog")]
    public class DbStorage_File_User_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_User_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_User_Link>(Changes);
        }
        #endregion
    }
}
