...
{
    [Table("File_VirtualSubUnit_User")]
    public class DbStorage_File_VirtualSubUnit_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_File_VirtualSubUnit_User_Notification>? Notifications { get; set; }

        [InverseProperty("User")]
        public virtual DbStorage_File_VirtualSubUnit_User_Permission? Permissions { get; set; }
