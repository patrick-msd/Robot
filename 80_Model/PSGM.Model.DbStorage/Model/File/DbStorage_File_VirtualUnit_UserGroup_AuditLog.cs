...
{
    [Table("File_VirtualUnit_UserGroup_AuditLog")]
    public class DbStorage_File_VirtualUnit_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_VirtualUnit_UserGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_VirtualUnit_UserGroup>(Changes);
        }
        #endregion
    }
}
