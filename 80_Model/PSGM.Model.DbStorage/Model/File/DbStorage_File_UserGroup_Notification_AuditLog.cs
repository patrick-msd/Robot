...
{
    [Table("File_UserGroup_Notification_AuditLog")]
    public class DbStorage_File_UserGroup_Notification_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_UserGroup_Notification? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_UserGroup_Notification>(Changes);
        }
        #endregion
    }
}
