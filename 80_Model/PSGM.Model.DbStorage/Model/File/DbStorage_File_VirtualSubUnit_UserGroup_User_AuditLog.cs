...
{
    [Table("File_VirtualSubUnit_UserGroup_User_AuditLog")]
    public class DbStorage_File_VirtualSubUnit_UserGroup_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_VirtualSubUnit_UserGroup_User? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_VirtualSubUnit_UserGroup_User>(Changes);
        }
        #endregion
    }
}
