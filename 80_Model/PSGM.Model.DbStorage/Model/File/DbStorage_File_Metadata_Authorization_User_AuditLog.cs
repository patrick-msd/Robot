...
{
    [Table("File_Metadata_Authorization_User_AuditLog")]
    public class DbStorage_File_Metadata_Authorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Metadata_Authorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Metadata_Authorization_User>(Changes);
        }
        #endregion
    }
}
