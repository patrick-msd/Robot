...
{
    [Table("File_VirtualUnit_AuditLog")]
    public class DbStorage_File_VirtualUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_VirtualUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_VirtualUnit>(Changes);
        }
        #endregion
    }
}
