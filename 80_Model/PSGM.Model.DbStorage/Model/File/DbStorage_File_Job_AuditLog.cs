...
{
    [Table("File_Job_AuditLog")]
    public class DbStorage_File_Job_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Job? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Job>(Changes);
        }
        #endregion
    }
}
