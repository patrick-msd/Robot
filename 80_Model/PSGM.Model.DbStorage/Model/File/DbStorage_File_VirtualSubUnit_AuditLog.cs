...
{
    [Table("File_VirtualSubUnit_AuditLog")]
    public class DbStorage_File_VirtualSubUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_VirtualSubUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_VirtualSubUnit>(Changes);
        }
        #endregion
    }
}
