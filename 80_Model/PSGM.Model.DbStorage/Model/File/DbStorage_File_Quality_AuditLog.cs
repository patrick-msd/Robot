...
{
    [Table("File_Quality_AuditLog")]
    public class DbStorage_File_Quality_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Quality GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Quality>(Changes);
        }
        #endregion
    }
}
