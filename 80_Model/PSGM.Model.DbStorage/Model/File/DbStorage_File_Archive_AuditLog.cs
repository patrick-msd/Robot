...
{
    [Table("File_Archive_AuditLog")]
    public class DbStorage_File_Archive_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Archive? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Archive>(Changes);
        }
        #endregion
    }
}
