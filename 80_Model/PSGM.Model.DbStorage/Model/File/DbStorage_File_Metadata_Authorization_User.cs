...
{
    [Table("File_Metadata_Authorization_User")]
    public class DbStorage_File_Metadata_Authorization_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_File_Metadata_Authorization_User_Link>? AuthorizationUserLinks { get; set; }
        #endregion
