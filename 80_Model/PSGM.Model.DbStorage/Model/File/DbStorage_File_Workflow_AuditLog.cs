...
{
    [Table("File_Workflow_AuditLog")]
    public class DbStorage_File_Workflow_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Workflow? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Workflow>(Changes);
        }
        #endregion
    }
}
