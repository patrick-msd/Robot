...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_File_User_Permission_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_User_Permission? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_User_Permission>(Changes);
        }
        #endregion
    }
}
