...
{
    [Table("RootDirectory_UserGroup")]
    public class DbStorage_RootDirectory_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_RootDirectory_UserGroup_Notification>? Notifications { get; set; }

        [InverseProperty("UserGroup")]
        public virtual DbStorage_RootDirectory_UserGroup_Permission? Permissions { get; set; }

        [InverseProperty("UserGroup")]
        public virtual ICollection<DbStorage_RootDirectory_UserGroup_Link>? UserGroupLinks { get; set; }

        [InverseProperty("UserGroup")]
        public virtual ICollection<DbStorage_RootDirectory_UserGroup_User_Link>? UserLinks { get; set; }
        #endregion
