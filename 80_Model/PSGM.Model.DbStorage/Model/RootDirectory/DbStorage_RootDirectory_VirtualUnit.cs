...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectory_VirtualUnit
    {
        #region Entities
        [Key]
        [Required]
        ...
        [Column("VirtualUnitId_Ext")]
        [Display(Name = "VirtualUnitId_Ext")]
        public Guid VirtualUnitId_Ext { get; set; } = Guid.Empty;
