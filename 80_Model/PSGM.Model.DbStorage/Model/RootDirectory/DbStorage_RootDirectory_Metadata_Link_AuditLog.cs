...
{
    [Table("RootDirectory_Metadata_Link_AuditLog")]
    public class DbStorage_RootDirectory_Metadata_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_File_Metadata GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_File_Metadata>(Changes);
        }
        #endregion
    }
}
