...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectory_Notification_User_Link_AuditLog
    {
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_Notification_User_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_Notification_User_Link>(Changes);
        }
        #endregion
    }
}
