...
{
    [Table("RootDirectory_VirtualRootUnit_User_Notification_AuditLog")]
    public class DbStorage_RootDirectory_VirtualRootUnit_User_Notification_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualRootUnit_User_Notification? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualRootUnit_User_Notification>(Changes);
        }
        #endregion
    }
}
