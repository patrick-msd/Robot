...
{
    [Table("RootDirectory_User_AuditLog")]
    public class DbStorage_RootDirectory_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_User? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_User>(Changes);
        }
        #endregion
    }
}
