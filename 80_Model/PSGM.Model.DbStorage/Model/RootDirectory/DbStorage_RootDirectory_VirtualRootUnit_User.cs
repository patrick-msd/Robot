...
{
    [Table("RootDirectory_VirtualRootUnit_User")]
    public class DbStorage_RootDirectory_VirtualRootUnit_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_RootDirectory_VirtualRootUnit_User_Notification>? Notifications { get; set; }

        [InverseProperty("User")]
        public virtual DbStorage_RootDirectory_VirtualRootUnit_User_Permission? Permissions { get; set; }
