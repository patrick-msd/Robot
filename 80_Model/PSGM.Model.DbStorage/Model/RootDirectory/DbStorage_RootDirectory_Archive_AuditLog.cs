...
{
    [Table("RootDirectory_Archive_AuditLog")]
    public class DbStorage_RootDirectory_Archive_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_Archive? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_Archive>(Changes);
        }
        #endregion
    }
}
