...
{
    [Table("RootDirectory_UserGroup_AuditLog")]
    public class DbStorage_RootDirectory_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_UserGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_UserGroup>(Changes);
        }
        #endregion
    }
}
