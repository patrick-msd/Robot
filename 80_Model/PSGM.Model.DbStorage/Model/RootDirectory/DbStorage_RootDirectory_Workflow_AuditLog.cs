...
{
    [Table("RootDirectory_Workflow_AuditLog")]
    public class DbStorage_RootDirectory_Workflow_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_Workflow? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_Workflow>(Changes);
        }
        #endregion
    }
}
