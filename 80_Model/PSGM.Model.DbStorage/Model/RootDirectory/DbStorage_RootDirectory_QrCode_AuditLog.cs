...
{
    [Table("RootDirectory_QrCode_AuditLog")]
    public class DbStorage_RootDirectory_QrCode_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_QrCode? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_QrCode>(Changes);
        }
        #endregion
    }
}
