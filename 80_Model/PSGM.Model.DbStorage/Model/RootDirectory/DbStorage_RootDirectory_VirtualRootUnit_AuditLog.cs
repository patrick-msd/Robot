...
{
    [Table("RootDirectory_VirtualRootUnit_AuditLog")]
    public class DbStorage_RootDirectory_VirtualRootUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualRootUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualRootUnit>(Changes);
        }
        #endregion
    }
}
