...
{
    [Table("RootDirectory_VirtualRootUnit_UserGroup_Permission_AuditLog")]
    public class DbStorage_RootDirectory_VirtualRootUnit_UserGroup_Permission_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualRootUnit_UserGroup_Permission? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualRootUnit_UserGroup_Permission>(Changes);
        }
        #endregion
    }
}
