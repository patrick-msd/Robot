...
{
    [Table("RootDirectory_Metadata_Authorization_UserGroup_AuditLog")]
    public class DbStorage_RootDirectory_Metadata_Authorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_Metadata_Authorization_UserGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_Metadata_Authorization_UserGroup>(Changes);
        }
        #endregion
    }
}
