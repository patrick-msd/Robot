...
{
    [Table("RootDirectory_Job_AuditLog")]
    public class DbStorage_RootDirectory_Job_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_Job? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_Job>(Changes);
        }
        #endregion
    }
}
