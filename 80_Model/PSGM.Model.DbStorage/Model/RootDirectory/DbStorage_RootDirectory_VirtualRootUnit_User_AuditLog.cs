...
{
    [Table("RootDirectory_VirtualRootUnit_User_AuditLog")]
    public class DbStorage_RootDirectory_VirtualRootUnit_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualRootUnit_User? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualRootUnit_User>(Changes);
        }
        #endregion
    }
}
