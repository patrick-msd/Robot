...
{
    [Table("RootDirectory_Quality_AuditLog")]
    public class DbStorage_RootDirectory_Quality_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_Quality GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_Quality>(Changes);
        }
        #endregion
    }
}
