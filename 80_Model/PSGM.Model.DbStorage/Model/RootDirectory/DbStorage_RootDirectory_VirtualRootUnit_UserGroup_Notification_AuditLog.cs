...
{
    [Table("RootDirectory_VirtualRootUnit_UserGroup_Notification_AuditLog")]
    public class DbStorage_RootDirectory_VirtualRootUnit_UserGroup_Notification_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualRootUnit_UserGroup_Notification? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualRootUnit_UserGroup_Notification>(Changes);
        }
        #endregion
    }
}
