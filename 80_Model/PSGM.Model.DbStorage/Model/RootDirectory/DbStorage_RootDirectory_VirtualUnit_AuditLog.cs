...
{
    [Table("RootDirectory_VirtualUnit_AuditLog")]
    public class DbStorage_RootDirectory_VirtualUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualUnit>(Changes);
        }
        #endregion
    }
}
