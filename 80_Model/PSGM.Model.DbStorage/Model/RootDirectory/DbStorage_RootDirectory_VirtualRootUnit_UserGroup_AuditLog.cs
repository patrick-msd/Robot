...
{
    [Table("RootDirectory_VirtualRootUnit_UserGroup_AuditLog")]
    public class DbStorage_RootDirectory_VirtualRootUnit_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectory_VirtualRootUnit_UserGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectory_VirtualRootUnit_UserGroup>(Changes);
        }
        #endregion
    }
}
