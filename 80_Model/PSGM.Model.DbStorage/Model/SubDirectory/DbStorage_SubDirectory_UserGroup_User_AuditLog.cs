...
{
    [Table("SubDirectory_UserGroup_User_AuditLog")]
    public class DbStorage_SubDirectory_UserGroup_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_UserGroup_User? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_UserGroup_User>(Changes);
        }
        #endregion
    }
}
