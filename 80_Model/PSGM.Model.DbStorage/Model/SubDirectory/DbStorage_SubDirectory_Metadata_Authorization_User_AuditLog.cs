...
{
    [Table("SubDirectory_Metadata_Authorization_User_AuditLog")]
    public class DbStorage_SubDirectory_Metadata_Authorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_Metadata_Authorization_User GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_Metadata_Authorization_User>(Changes);
        }
        #endregion
    }
}
