...
{
    [Table("SubDirectory_VirtualSubUnit_User_Permission_AuditLog")]
    public class DbStorage_SubDirectory_VirtualSubUnit_User_Permission_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualSubUnit_User_Permission? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualSubUnit_User_Permission>(Changes);
        }
        #endregion
    }
}
