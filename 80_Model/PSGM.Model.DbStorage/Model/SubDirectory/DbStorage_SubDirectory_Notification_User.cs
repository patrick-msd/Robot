...
{
    [Table("SubDirectory_Notification_User")]
    public class DbStorage_SubDirectory_Notification_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_SubDirectory_Notification_User_Link>? NotificationUserLinks { get; set; }
        #endregion
