...
{
    [Table("SubDirectory_Notification_User_AuditLog")]
    public class DbStorage_SubDirectory_Notification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_Notification_User GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_Notification_User>(Changes);
        }
        #endregion
    }
}
