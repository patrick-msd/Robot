...
{
    [Table("SubDirectory_VirtualUnit_AuditLog")]
    public class DbStorage_SubDirectory_VirtualUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualUnit>(Changes);
        }
        #endregion
    }
}
