...
{
    [Table("SubDirectory_VirtualSubUnit_UserGroup_AuditLog")]
    public class DbStorage_SubDirectory_VirtualSubUnit_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualSubUnit_UserGroup? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualSubUnit_UserGroup>(Changes);
        }
        #endregion
    }
}
