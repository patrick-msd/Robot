...
{
    [Table("SubDirectory_Workflow_AuditLog")]
    public class DbStorage_SubDirectory_Workflow_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_Workflow? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_Workflow>(Changes);
        }
        #endregion
    }
}
