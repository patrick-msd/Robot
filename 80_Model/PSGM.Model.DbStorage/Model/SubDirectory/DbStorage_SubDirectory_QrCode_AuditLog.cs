...
{
    [Table("SubDirectory_QrCode_AuditLog")]
    public class DbStorage_SubDirectory_QrCode_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_QrCode? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_QrCode>(Changes);
        }
        #endregion
    }
}
