...
{
    [Table("SubDirectory_VirtualUnit_User")]
    public class DbStorage_SubDirectory_VirtualUnit_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_SubDirectory_VirtualUnit_User_Notification>? Notifications { get; set; }

        [InverseProperty("User")]
        public virtual DbStorage_SubDirectory_VirtualUnit_User_Permission? Permissions { get; set; }
