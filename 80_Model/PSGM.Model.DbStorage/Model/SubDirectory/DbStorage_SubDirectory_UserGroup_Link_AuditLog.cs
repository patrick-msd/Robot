...
{
    [Table("SubDirectory_UserGroup_Link_AuditLog")]
    public class DbStorage_SubDirectory_UserGroup_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_UserGroup_Link? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_UserGroup_Link>(Changes);
        }
        #endregion
    }
}
