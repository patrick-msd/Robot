...
{
    [Table("SubDirectory_Metadata_Authorization_User_Link_AuditLog")]
    public class DbStorage_SubDirectory_Metadata_Authorization_User_Link_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_Metadata_Authorization_User_Link>(Changes);
        }
        #endregion
    }
}
