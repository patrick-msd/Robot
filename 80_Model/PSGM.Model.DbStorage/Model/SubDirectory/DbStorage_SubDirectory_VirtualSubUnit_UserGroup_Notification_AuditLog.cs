...
{
    [Table("SubDirectory_VirtualSubUnit_UserGroup_Notification_AuditLog")]
    public class DbStorage_SubDirectory_VirtualSubUnit_UserGroup_Notification_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualSubUnit_UserGroup_Notification? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualSubUnit_UserGroup_Notification>(Changes);
        }
        #endregion
    }
}
