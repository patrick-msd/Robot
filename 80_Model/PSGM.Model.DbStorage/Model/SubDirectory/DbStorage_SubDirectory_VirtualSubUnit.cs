...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_SubDirectory_VirtualSubUnit
    {
        #region Entities
        [Key]
        [Required]
        ...
        [Column("VirtualSubUnitId_Ext")]
        [Display(Name = "VirtualSubUnitId_Ext")]
        public Guid VirtualSubUnitId_Ext { get; set; } = Guid.Empty;
        ...
        public virtual ICollection<DbStorage_SubDirectory_VirtualSubUnit_User_Link>? UserLinks { get; set; }
