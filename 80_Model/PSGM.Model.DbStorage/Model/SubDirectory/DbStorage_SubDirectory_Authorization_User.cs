...
{
    [Table("SubDirectory_Authorization_User")]
    public class DbStorage_SubDirectory_Authorization_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_SubDirectory_Authorization_User_Link>? AuthorizationUserLinks { get; set; }
        #endregion
