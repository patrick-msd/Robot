...
{
    [Table("SubDirectory_VirtualSubUnit_UserGroup_Permission_AuditLog")]
    public class DbStorage_SubDirectory_VirtualSubUnit_UserGroup_Permission_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualSubUnit_UserGroup_Permission? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualSubUnit_UserGroup_Permission>(Changes);
        }
        #endregion
    }
}
