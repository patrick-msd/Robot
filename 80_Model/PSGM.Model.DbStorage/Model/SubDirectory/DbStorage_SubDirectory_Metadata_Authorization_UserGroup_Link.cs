...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_SubDirectory_Metadata_Authorization_UserGroup_Link
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual DbStorage_SubDirectory_Metadata_Authorization_UserGroup? AuthorizationUserGroup { get; set; }
        #endregion
