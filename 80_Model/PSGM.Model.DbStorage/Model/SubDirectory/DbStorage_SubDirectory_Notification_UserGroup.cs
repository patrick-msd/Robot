...
{
    [Table("SubDirectory_Notification_UserGroup")]
    public class DbStorage_SubDirectory_Notification_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_SubDirectory_Notification_UserGroup_Link>? NotificationUserGroupLinks { get; set; }
        #endregion
