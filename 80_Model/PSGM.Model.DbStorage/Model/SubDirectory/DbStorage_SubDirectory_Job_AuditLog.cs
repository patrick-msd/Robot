...
{
    [Table("SubDirectory_Job_AuditLog")]
    public class DbStorage_SubDirectory_Job_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_Job? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_Job>(Changes);
        }
        #endregion
    }
}
