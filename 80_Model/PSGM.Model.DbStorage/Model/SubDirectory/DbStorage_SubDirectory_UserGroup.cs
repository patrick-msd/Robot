...
{
    [Table("SubDirectory_UserGroup")]
    public class DbStorage_SubDirectory_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_SubDirectory_UserGroup_Notification>? Notifications { get; set; }

        [InverseProperty("UserGroup")]
        public virtual DbStorage_SubDirectory_UserGroup_Permission? Permissions { get; set; }

        [InverseProperty("UserGroup")]
        public virtual ICollection<DbStorage_SubDirectory_UserGroup_Link>? UserGroupLinks { get; set; }

        [InverseProperty("UserGroup")]
        public virtual ICollection<DbStorage_SubDirectory_UserGroup_User_Link>? UserLinks { get; set; }
        #endregion
