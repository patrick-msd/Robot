...
{
    [Table("SubDirectory_VirtualUnit_User_Notification_AuditLog")]
    public class DbStorage_SubDirectory_VirtualUnit_User_Notification_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualUnit_User_Notification? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualUnit_User_Notification>(Changes);
        }
        #endregion
    }
}
