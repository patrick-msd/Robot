...
{
    [Table("SubDirectory_Authorization_UserGroup")]
    public class DbStorage_SubDirectory_Authorization_UserGroup
    {
        #region Entities
        [Key]
        [Required]
        ...
        public virtual ICollection<DbStorage_SubDirectory_Authorization_UserGroup_Link>? AuthorizationUserGroupLinks { get; set; }
        #endregion
