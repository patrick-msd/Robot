...
{
    [Table("SubDirectory_Archive_AuditLog")]
    public class DbStorage_SubDirectory_Archive_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_Archive? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_Archive>(Changes);
        }
        #endregion
    }
}
