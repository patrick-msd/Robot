...
{
    [Table("SubDirectory_VirtualSubUnit_User_AuditLog")]
    public class DbStorage_SubDirectory_VirtualSubUnit_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualSubUnit_User? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualSubUnit_User>(Changes);
        }
        #endregion
    }
}
