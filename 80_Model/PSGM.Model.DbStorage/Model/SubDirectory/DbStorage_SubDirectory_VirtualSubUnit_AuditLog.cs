...
{
    [Table("SubDirectory_VirtualSubUnit_AuditLog")]
    public class DbStorage_SubDirectory_VirtualSubUnit_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectory_VirtualSubUnit? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectory_VirtualSubUnit>(Changes);
        }
        #endregion
    }
}
