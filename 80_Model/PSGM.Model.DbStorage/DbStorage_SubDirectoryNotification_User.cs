...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_SubDirectoryNotification_User
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Links
        [InverseProperty("SubDirectoryNotification_User")]
        public virtual ICollection<DbStorage_SubDirectoryNotification_UserLink>? SubDirectoryNotification_UserLinks { get; set; }
        #endregion
