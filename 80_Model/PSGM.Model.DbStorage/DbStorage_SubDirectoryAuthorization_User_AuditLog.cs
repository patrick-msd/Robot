...
{
    [Table("SubDirectoryAuthorization_User_AuditLog")]
    public class DbStorage_SubDirectoryAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryAuthorization_User>(Changes);
        }
        #endregion
    }
}
