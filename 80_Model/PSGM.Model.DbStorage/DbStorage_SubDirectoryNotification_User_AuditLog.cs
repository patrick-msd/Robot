...
{
    [Table("SubDirectoryNotification_User_AuditLog")]
    public class DbStorage_SubDirectoryNotification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryNotification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryNotification_User>(Changes);
        }
        #endregion
    }
}
