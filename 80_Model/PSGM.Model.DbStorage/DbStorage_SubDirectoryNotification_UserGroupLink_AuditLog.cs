...
{
    [Table("SubDirectoryNotification_UserGroupLink_AuditLog")]
    public class DbStorage_SubDirectoryNotification_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryNotification_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryNotification_UserGroupLink>(Changes);
        }
        #endregion
    }
}
