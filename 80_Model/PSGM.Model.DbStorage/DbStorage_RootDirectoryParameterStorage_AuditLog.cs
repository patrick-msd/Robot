...
{
    [Table("RootDirectoryParameterStorage_AuditLog")]
    public class DbStorage_RootDirectoryParameterStorage_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryParameterStorage GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryParameterStorage>(Changes);
        }
        #endregion
    }
}
