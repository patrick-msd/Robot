...
namespace PSGM.Model.DbStorage
{
    ...
    public class DbStorage_RootDirectoryMetadata
    {
        ...
        public virtual ICollection<DbStorage_RootDirectoryMetadataAuthorization_UserLink>? Authorization_UserLinks { get; set; }

        [InverseProperty("RootDirectoryMetadata")]
        public virtual ICollection<DbStorage_RootDirectoryMetadataAuthorization_UserGroupLink>? Authorization_UserGroupLinks { get; set; }
