...
{
    [Table("RootDirectoryAuthorization_User_AuditLog")]
    public class DbStorage_RootDirectoryAuthorization_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryAuthorization_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryAuthorization_User>(Changes);
        }
        #endregion
    }
}
