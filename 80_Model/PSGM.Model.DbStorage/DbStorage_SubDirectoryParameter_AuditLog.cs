...
{
    [Table("SubDirectoryParameter_AuditLog")]
    public class DbStorage_SubDirectoryParameter_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryParameter GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryParameter>(Changes);
        }
        #endregion
    }
}
