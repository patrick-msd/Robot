...
{
    [Table("RootDirectoryAuthorization_UserGroupLink_AuditLog")]
    public class DbStorage_RootDirectoryAuthorization_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryAuthorization_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryAuthorization_UserGroupLink>(Changes);
        }
        #endregion
    }
}
