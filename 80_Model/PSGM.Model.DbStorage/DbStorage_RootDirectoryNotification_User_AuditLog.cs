...
{
    [Table("RootDirectoryNotification_User_AuditLog")]
    public class DbStorage_RootDirectoryNotification_User_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryNotification_User GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryNotification_User>(Changes);
        }
        #endregion
    }
}
