...
{
    [Table("RootDirectoryAuthorization_UserGroup_AuditLog")]
    public class DbStorage_RootDirectoryAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
