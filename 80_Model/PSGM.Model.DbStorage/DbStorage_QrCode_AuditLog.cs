...
{
    [Table("QrCode_AuditLog")]
    public class DbStorage_QrCode_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_QrCode GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_QrCode>(Changes);
        }
        #endregion
    }
}
