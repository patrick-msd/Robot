...
{
    [Table("RootDirectoryMetadataAuthorization_UserGroup_AuditLog")]
    public class DbStorage_RootDirectoryMetadataAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryMetadataAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryMetadataAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
