...
{
    [Table("FileMetadataAuthorization_UserGroup_AuditLog")]
    public class DbStorage_FileMetadataAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileMetadataAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileMetadataAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
