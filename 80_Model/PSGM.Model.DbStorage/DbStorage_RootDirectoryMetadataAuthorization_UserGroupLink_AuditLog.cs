...
{
    [Table("RootDirectoryMetadataAuthorization_UserGroupLink_AuditLog")]
    public class DbStorage_RootDirectoryMetadataAuthorization_UserGroupLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_RootDirectoryMetadataAuthorization_UserGroupLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorage_RootDirectoryMetadataAuthorization_UserGroupLink>(Changes);
        }
        #endregion
    }
}
