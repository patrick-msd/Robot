...
{
    [Table("SubDirectoryMetadataAuthorization_UserGroup_AuditLog")]
    public class DbStorage_SubDirectoryMetadataAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_SubDirectoryMetadataAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_SubDirectoryMetadataAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
