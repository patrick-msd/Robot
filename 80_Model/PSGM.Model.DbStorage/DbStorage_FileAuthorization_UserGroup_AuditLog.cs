...
{
    [Table("FileAuthorization_UserGroup_AuditLog")]
    public class DbStorage_FileAuthorization_UserGroup_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorage_FileAuthorization_UserGroup GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorage_FileAuthorization_UserGroup>(Changes);
        }
        #endregion
    }
}
