...
namespace PSGM.Model.DbBackendStructure
{
    ...
    public class DbBackendStructure_Project_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbBackendStructure_Project? GetChanges()
        {
            return JsonConvert.DeserializeObject<DbBackendStructure_Project>(Changes);
        }
        #endregion
    }
}
