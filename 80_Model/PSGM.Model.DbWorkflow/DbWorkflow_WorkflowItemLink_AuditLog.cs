...
{
    [Table("WorkflowItemLink_AuditLog")]
    public class DbWorkflow_WorkflowItemLink_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbWorkflow_WorkflowItemLink GetChanges()
        {
            return JsonConvert.DeserializeObject<DbWorkflow_WorkflowItemLink>(Changes);
        }
        #endregion
    }
}
