...
{
    [Table("WorkflowItem_AuditLog")]
    public class DbWorkflow_WorkflowItem_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbWorkflow_WorkflowItem GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbWorkflow_WorkflowItem>(Changes);
        }
        #endregion
    }
}
