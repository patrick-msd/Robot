...
{
    public class DbArchiv_Context : DbContext
    {
        #region Variables
        ...
        private string _connectionStringSQLite = "Data Source=C:\\Git\\MSD\\Robot\\80_Model\\PSGM.Model.DbArchiv\\DbArchiv.db";
        ...
        #region Context
        public DbArchiv_Context() : base()
        {
        }

        public DbArchiv_Context(DbContextOptions<DbArchiv_Context> options) : base(options)
        {
        }

        public DbArchiv_Context(DatabaseType databaseType, string connectionString) : base()
        {
        ...
        #region DataSets
        public DbSet<DbArchiv_Job> Jobs { get; set; }
        public DbSet<DbArchiv_Job_AuditLog> Job_AuditLog { get; set; }
        #endregion
        ...
        public override int SaveChanges()
        {
            ...
            foreach (var entry in entries)
            {
                switch (entry.Entity)
                {
                    case DbArchiv_Job job:
                        Job_AuditLog.Add(new DbArchiv_Job_AuditLog
                        {
                            Id = new Guid(),
                    ...
                    case DbArchiv_Job_AuditLog job_AuditLog:
                        break;
