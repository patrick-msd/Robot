...
{
    [Table("Project_AuditLog")]
    public class DbStorageStructure_Project_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorageStructure_Project GetChanges()
        {
            return JsonConvert.DeserializeObject<DbStorageStructure_Project>(Changes);
        }
        #endregion
    }
}
