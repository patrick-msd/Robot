...
{
    [Table("ProjectParameterStorage_AuditLog")]
    public class DbStorageStructure_ProjectStorage_AuditLog
    {
        #region Entities
        [Key]
        [Required]
        ...
        #region Not Mapped
        public DbStorageStructure_ProjectStorage GetChagnes()
        {
            return JsonConvert.DeserializeObject<DbStorageStructure_ProjectStorage>(Changes);
        }
        #endregion
    }
}
