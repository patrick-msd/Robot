...
namespace PSGM.Sample.Model.DbBackend
{
    ...
    {
        public async void Setup_Storage_DBStorageDataRawThumbnail(DbBackend_Project projects)
        {
            ...
            DbBackend_Storage_Cluster cluster = clusters.Where(p => p.StorageClass == StorageClass.DataRawThumbnail).FirstOrDefault();
