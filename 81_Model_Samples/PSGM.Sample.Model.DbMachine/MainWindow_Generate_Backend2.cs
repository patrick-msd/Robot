...
namespace PSGM.Sample.Model.DbBackend
{
    ...
    {
        public List<DbBackend_Backend> Generate_Backend2(int count, List<DbBackend_Database_Server> projects)
        {
            Random random = new Random();

            List<DbBackend_Backend> tmp = new List<DbBackend_Backend>();
