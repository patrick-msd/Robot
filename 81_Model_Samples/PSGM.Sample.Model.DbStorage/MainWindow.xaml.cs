...
namespace PSGM.Sample.Model.DbStorage
{
    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        public MainWindow()
        {
            ...
            btnDbReadConfigFileAndInit_Click(null, null);
            #endregion
        ...
        private void btnDbGenerateData_Click(object sender, RoutedEventArgs e)
        {
            ...
            List<DbStorage_RootDirectory> rootDirectory = Create_RootDirectories(10, users, userGroups, notificationUsers, notificationUserGroups);
            ...
            List<DbStorage_SubDirectory> subDirectories = Create_SubDirectories(100, users, userGroups, notificationUsers, notificationUserGroups, rootDirectory);
            _dbStorage_Data_Context.SubDirectories.AddRange(subDirectories);
            _dbStorage_Data_Context.SaveChanges();
            #endregion

            #region Add sub sub directories ...
            List<DbStorage_SubDirectory> subsubDirectories = Create_SubSubDirectories(10, users, userGroups, notificationUsers, notificationUserGroups, rootDirectory);
            _dbStorage_Data_Context.SubDirectories.AddRange(subsubDirectories);
            _dbStorage_Data_Context.SaveChanges();
            #endregion

            #region Add files ...
            List<DbStorage_File> files1 = Create_Files1(1000, users, userGroups, notificationUsers, notificationUserGroups, subsubDirectories, rootDirectory);
            _dbStorage_Data_Context.Files.AddRange(files1);
            _dbStorage_Data_Context.SaveChanges();

            List<DbStorage_File> files2 = Create_Files2(1000, users, userGroups, notificationUsers, notificationUserGroups, subsubDirectories, rootDirectory);
