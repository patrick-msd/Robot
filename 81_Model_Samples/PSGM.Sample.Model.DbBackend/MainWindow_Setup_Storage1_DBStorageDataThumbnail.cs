...
namespace PSGM.Sample.Model.DbBackend
{
    ...
    {
        public async void Setup_Storage_DBStorageDataThumbnail(DbBackend_Project projects)
        {
            IMinioClient minioClient;

            //DbBackend_Backend? structure = projects.Cluster.Where(p => p.StorageClass == StorageClass.DataThumbnail).FirstOrDefault();
