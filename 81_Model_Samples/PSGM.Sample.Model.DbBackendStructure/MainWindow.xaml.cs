...
namespace PSGM.Sample.Model.DbBackendStructure
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private DbBackendStructure_Context _dbBackendStructure_Context;
        ...
        public MainWindow()
        {
            ...
            if (_configFile.ConfigFileExists(Directory.GetCurrentDirectory() + "\\ConfigFile.json"))
            {
                _dbBackendStructure_Context = new DbBackendStructure_Context();

                _dbBackendStructure_Context.DatabaseConnectionString = _configFile.DatabaseConnectionString;
                _dbBackendStructure_Context.DatabaseType = _configFile.DatabaseType;

                _dbBackendStructure_Context.DatabaseSessionParameter_SoftwareId = _softwareId;
                _dbBackendStructure_Context.DatabaseSessionParameter_MachineId = _machineId;
                _dbBackendStructure_Context.DatabaseSessionParameter_UserId = _patrickSchoeneggerId;

                if (_dbBackendStructure_Context.Database.EnsureCreated())
                {
                    _dbBackendStructure_Context.Database.OpenConnection();
                }
        ...
        private void btnDbReadConfigFileAndInit_Click(object sender, RoutedEventArgs e)
        {
            ...
            _dbBackendStructure_Context.DatabaseConnectionString = _configFile.DatabaseConnectionString;
            _dbBackendStructure_Context.DatabaseType = _configFile.DatabaseType;
            _dbBackendStructure_Context.Database.EnsureDeleted();
            _dbBackendStructure_Context.Database.EnsureCreated();
            _dbBackendStructure_Context.Database.OpenConnection();
        }
