...
public class Result : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          NanolibPINVOKE.delete_Result(swigCPtr);
        }
  ...
  public bool hasError() {
    bool ret = NanolibPINVOKE.Result_hasError(swigCPtr);
    return ret;
  }

  public string getError() {
    string ret = NanolibPINVOKE.Result_getError(swigCPtr);
    return ret;
  }

  public NlcErrorCode getErrorCode() {
    NlcErrorCode ret = (NlcErrorCode)NanolibPINVOKE.Result_getErrorCode(swigCPtr);
    return ret;
  }

  public uint getExErrorCode() {
    uint ret = NanolibPINVOKE.Result_getExErrorCode(swigCPtr);
    return ret;
  }
