...
public class ByteVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<byte>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          NanolibPINVOKE.delete_ByteVector(swigCPtr);
        }
  ...
  public void Clear() {
    NanolibPINVOKE.ByteVector_Clear(swigCPtr);
  }

  public void Add(byte x) {
    NanolibPINVOKE.ByteVector_Add(swigCPtr, x);
  }

  private uint size() {
    uint ret = NanolibPINVOKE.ByteVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = NanolibPINVOKE.ByteVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    NanolibPINVOKE.ByteVector_reserve(swigCPtr, n);
  }

  public ByteVector() : this(NanolibPINVOKE.new_ByteVector__SWIG_0(), true) {
  }

  public ByteVector(ByteVector other) : this(NanolibPINVOKE.new_ByteVector__SWIG_1(ByteVector.getCPtr(other)), true) {
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public ByteVector(int capacity) : this(NanolibPINVOKE.new_ByteVector__SWIG_2(capacity), true) {
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  private byte getitemcopy(int index) {
    byte ret = NanolibPINVOKE.ByteVector_getitemcopy(swigCPtr, index);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private byte getitem(int index) {
    byte ret = NanolibPINVOKE.ByteVector_getitem(swigCPtr, index);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, byte val) {
    NanolibPINVOKE.ByteVector_setitem(swigCPtr, index, val);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(ByteVector values) {
    NanolibPINVOKE.ByteVector_AddRange(swigCPtr, ByteVector.getCPtr(values));
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public ByteVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = NanolibPINVOKE.ByteVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, byte x) {
    NanolibPINVOKE.ByteVector_Insert(swigCPtr, index, x);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, ByteVector values) {
    NanolibPINVOKE.ByteVector_InsertRange(swigCPtr, index, ByteVector.getCPtr(values));
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    NanolibPINVOKE.ByteVector_RemoveAt(swigCPtr, index);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    NanolibPINVOKE.ByteVector_RemoveRange(swigCPtr, index, count);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public static ByteVector Repeat(byte value, int count) {
    global::System.IntPtr cPtr = NanolibPINVOKE.ByteVector_Repeat(value, count);
    ByteVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new ByteVector(cPtr, true);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    NanolibPINVOKE.ByteVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    NanolibPINVOKE.ByteVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, ByteVector values) {
    NanolibPINVOKE.ByteVector_SetRange(swigCPtr, index, ByteVector.getCPtr(values));
    if (NanolibPINVOKE.SWIGPendingException.Pending) throw NanolibPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Contains(byte value) {
    bool ret = NanolibPINVOKE.ByteVector_Contains(swigCPtr, value);
    return ret;
  }

  public int IndexOf(byte value) {
    int ret = NanolibPINVOKE.ByteVector_IndexOf(swigCPtr, value);
    return ret;
  }

  public int LastIndexOf(byte value) {
    int ret = NanolibPINVOKE.ByteVector_LastIndexOf(swigCPtr, value);
    return ret;
  }

  public bool Remove(byte value) {
    bool ret = NanolibPINVOKE.ByteVector_Remove(swigCPtr, value);
    return ret;
  }
