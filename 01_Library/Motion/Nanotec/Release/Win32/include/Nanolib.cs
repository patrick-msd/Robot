...
public class Nanolib {
  ...
  public static readonly int LOG_LEVEL_TRACE = NanolibPINVOKE.LOG_LEVEL_TRACE_get();
  public static readonly int LOG_LEVEL_DEBUG = NanolibPINVOKE.LOG_LEVEL_DEBUG_get();
  public static readonly int LOG_LEVEL_INFO = NanolibPINVOKE.LOG_LEVEL_INFO_get();
  public static readonly int LOG_LEVEL_WARN = NanolibPINVOKE.LOG_LEVEL_WARN_get();
  public static readonly int LOG_LEVEL_ERROR = NanolibPINVOKE.LOG_LEVEL_ERROR_get();
  public static readonly int LOG_LEVEL_CRITICAL = NanolibPINVOKE.LOG_LEVEL_CRITICAL_get();
  public static readonly int LOG_LEVEL_OFF = NanolibPINVOKE.LOG_LEVEL_OFF_get();
}
