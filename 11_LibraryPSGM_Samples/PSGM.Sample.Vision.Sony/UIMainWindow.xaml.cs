...
namespace PSGM.Sample.Vision.Sony
{
    /// <summary>
    ...
    public partial class UIMainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _sony = new PSGM.Lib.Vision.Sony.Sony_Container();
            _sony.Cameras.Add(new PSGM.Lib.Vision.Sony.Sony_Camera());
        ...
        private void Test_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                _task = Task.Run(async () =>
                {
                    ...
                    //PSGM.Lib.Vision.Sony.Sony_Container sony = new PSGM.Lib.Vision.Sony.Sony_Container();

                    ////sony.Cameras[0].Camera = new PSGM.Lib.Vision.Sony.Sony_Camera();
                    //uint sfg = sony.Cameras[0].Camera.GetSDKVersion();

                    uint sfg = _sony.Cameras[0].GetSDKVersion();

                    uint[] sfgsfsdf = _sony.Cameras[0].GetSDKVersionSplit();


                    _sony.Cameras[0].Init();

                    _sony.Cameras[0].EnumCameraObjects()
