...
namespace RC.Lib.PowerSupply
{
    public partial class NextysModbusClient
    {
        ...
        /// </summary>
        public NextysModbusClient(string portName = "COM1", int baudRate = 38400, Parity parity = Parity.Even, StopBits stopBit = StopBits.One, Handshake handshake = Handshake.None, int readTimeout = 1000, int writeTimeout = 1000, byte unitIdentifier = 0x01, int interval = 10000)
        {
            _portName = portName;
            _baudRate = baudRate;
            _parity = parity;
        ...
        public void Disconnect()
        {
            if (_serialPort != null)
            {
                if (_serialPort.IsOpen & !receiveActive)
                {
                    _serialPort.Close();
                }
        ...
        public void WriteSingleCoil(int startingAddress, bool value)
        {
            ...
            if (_serialPort != null)
            {
                dataReceived = false;
                bytesToRead = 8;
                //               _serialport.ReceivedBytesThreshold = bytesToRead;
        ...
        #region Converters "Registers To Datatype"
        /// <summary>
        ...
        public static float ConvertRegistersToFloat(int[] registers)
        {
            ...
            byte[] floatBytes = new byte[] { lowRegisterBytes[0], lowRegisterBytes[1], highRegisterBytes[0], highRegisterBytes[1] };
        ...
        public static Int32 ConvertRegistersToInt(int[] registers)
        {
            ...
            byte[] highRegisterBytes = BitConverter.GetBytes(highRegister);
            byte[] lowRegisterBytes = BitConverter.GetBytes(lowRegister);
            byte[] doubleBytes = new byte[] { lowRegisterBytes[0], lowRegisterBytes[1], highRegisterBytes[0], highRegisterBytes[1] };
        ...
        public static Int64 ConvertRegistersToLong(int[] registers)
        {
            ...
            byte[] lowRegisterBytes = BitConverter.GetBytes(lowRegister);
            byte[] longBytes = new byte[] { lowRegisterBytes[0], lowRegisterBytes[1], lowHighRegisterBytes[0], lowHighRegisterBytes[1], highLowRegisterBytes[0], highLowRegisterBytes[1], highRegisterBytes[0], highRegisterBytes[1] };
        ...
        #region Converters "Datatype To Registers"
        /// <summary>
        ...
        public static int[] ConvertFloatToRegisters(float floatValue)
        {
            ...
            byte[] highRegisterBytes = new byte[] { floatBytes[2], floatBytes[3], 0, 0 };
            byte[] lowRegisterBytes = new byte[] { floatBytes[0], floatBytes[1], 0, 0 };
            int[] returnValue = new int[] { BitConverter.ToInt32(lowRegisterBytes, 0), BitConverter.ToInt32(highRegisterBytes, 0) };
        ...
        public static int[] ConvertIntToRegisters(Int32 intValue)
        {
            ...
            byte[] highRegisterBytes = new byte[] { doubleBytes[2], doubleBytes[3], 0, 0 };
            byte[] lowRegisterBytes = new byte[] { doubleBytes[0], doubleBytes[1], 0, 0 };
            int[] returnValue = new int[] { BitConverter.ToInt32(lowRegisterBytes, 0), BitConverter.ToInt32(highRegisterBytes, 0) };
        ...
        public static int[] ConvertLongToRegisters(Int64 longValue)
        {
            ...
            byte[] highRegisterBytes = new byte[] { longBytes[6], longBytes[7], 0, 0 };
            byte[] highLowRegisterBytes = new byte[] { longBytes[4], longBytes[5], 0, 0 };
            byte[] lowHighRegisterBytes = new byte[] { longBytes[2], longBytes[3], 0, 0 };
            byte[] lowRegisterBytes = new byte[] { longBytes[0], longBytes[1], 0, 0 };
            int[] returnValue = new int[] { BitConverter.ToInt32(lowRegisterBytes, 0), BitConverter.ToInt32(lowHighRegisterBytes, 0), BitConverter.ToInt32(highLowRegisterBytes, 0), BitConverter.ToInt32(highRegisterBytes, 0) };
        ...
        public static int[] ConvertDoubleToRegisters(double doubleValue)
        {
            ...
            byte[] highRegisterBytes = new byte[] { doubleBytes[6], doubleBytes[7], 0, 0 };
            byte[] highLowRegisterBytes = new byte[] { doubleBytes[4], doubleBytes[5], 0, 0 };
            byte[] lowHighRegisterBytes = new byte[] { doubleBytes[2], doubleBytes[3], 0, 0 };
            byte[] lowRegisterBytes = new byte[] { doubleBytes[0], doubleBytes[1], 0, 0 };
            int[] returnValue = new int[] { BitConverter.ToInt32(lowRegisterBytes, 0), BitConverter.ToInt32(lowHighRegisterBytes, 0), BitConverter.ToInt32(highLowRegisterBytes, 0), BitConverter.ToInt32(highRegisterBytes, 0) };
